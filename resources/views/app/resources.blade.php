                        ...
                        <div class="col-md-7 offset-md-5 dossier xxs">
                            ...
                            <div class="row">
                                <div class="col-xs-6 col-sm-6">
                                    <a href="{{__('app.resources.dossiers_xef_dw_'.config('app.platform'))}}" target="_blank">
                                        <div class="item">
                                            <div class="icon"><div class="download">&nbsp;</div></div>
                                ...
                                <div class="col-xs-6 col-sm-6">
                                    <a href="{{__('app.resources.dossiers_retail_dw_'.config('app.platform'))}}" target="_blank">
                                        <div class="item">
                                            <div class="icon"><div class="download">&nbsp;</div></div>
                            ...
                            <div class="row">
                                <div class="col-xs-6 col-sm-6">
                                    <a href="{{__('app.resources.dossiers_flow_dw_'.config('app.platform'))}}" target="_blank">
                                        <div class="item">
                                            <div class="icon"><div class="download">&nbsp;</div></div>
                                ...
                                <div class="col-xs-6 col-sm-6">
                                    <a href="{{__('app.resources.dossiers_intouch_dw_'.config('app.platform'))}}" target="_blank">
                                        <div class="item">
                                            <div class="icon"><div class="download">&nbsp;</div></div>
