    ...
    <div class="col-sm-12 col-md-12">
        ...
        <div class="devices_wrapper @if (old('devices') == 1)shown @endif">
            ...
            <div class="textarea-wrap">
                ...
                @include('app.lead.components.error-field', ['name' => 'devices_current'])
            </div>
        </div>
    </div>
</div>
...
<div class="row show-on-{{App\Models\Product::XEF}}" style="display: none;">
    ...
    <div class="col-sm-4">
        <div class="form-group">
            @include('app.lead.components.input', ['name' => 'xef_cash_quantity', 'title' => 'xefCashQuantity'])
        </div>
    </div>
    <div class="col-sm-4">
        <div class="form-group">
            @include('app.lead.components.input', ['name' => 'xef_printers_quantity', 'title' => 'xefPrintersQuantity'])
        </div>
    </div>
</div>