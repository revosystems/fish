<div class="row @segmentClasses()" style="display: none;">
    <div class="col-sm-6 col-md-6">
        <div class="form-group isPicker @if($errors->has('pos'))is-invalid @endif">
            ...
            @include('components.lead.app-error-field', ['name' => 'pos'])
        </div>
    </div>
    <div class="col-sm-6 col-md-6">
...
<div class="row @segmentClasses()" style="display: none;">
    <div class="col-sm-12 col-md-12">
        @include('components.lead.app-select', ["options" => ['1' => __('app.lead.yes'), '0' => __('app.lead.no')], 'name' => 'franchise_pos_external', 'title' => 'retailSaleMode', 'disabledOn' => 'xef_property_franchise'])
    </div>
</div>
