...
<div class="card-body p-3">
    ...
    <div class="row">
        <div class="col-sm-12">
            @include('admin.leads.components.select', ['options' => App\Models\PropertySpace::all()->where('product', $lead->product), 'name' => 'property_spaces', 'title' => 'propertySpace', 'object' => $lead])
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
