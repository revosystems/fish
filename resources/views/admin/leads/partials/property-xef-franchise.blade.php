<div class="form-group isPicker @if ($errors->has('property_franchise'))is-invalid @endif">
    <select class="selectpicker form-control started" name="property_franchise"
            id="property_franchise" title="{{ __('app.lead.xefPropertyFranchise') }}"
            data-style="btn-light" data-size="5">
        <option value='1' @if ($lead->property_franchise == 1) selected
        ...
        <option value='0' @if ($lead->property_franchise == 0) selected
