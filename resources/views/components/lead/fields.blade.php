        ...
        <table class="no-padding">
            ...
            {{--<tr>--}}
                {{--<td>--}}
                    ...
                    {{--<select class="selectpicker" name="property_spaces[]" id="property_spaces" title="{{ __('app.lead.pySpaces') }}"  data-size="5" multiple>--}}
            ...
            {{--<tr>--}}
                {{--<td>--}}
                    ...
                    {{--@foreach(App/Models/LeadPropertySpaces::whereType(LeadType::XEF)->get() as $space)--}}
                    {{--<option value='{{$space->id}}' @if (old('property_spaces') !='' && in_array($space->id,old('property_spaces'))) {{ 'selected' }} @endif--}}
                    {{--@if (old('property_spaces') == $space->id)--}}
                    {{--{{ 'selected' }}--}}
                    {{--@endif--}}
...
<div class="grid">
    <div class="col-min33">
        <table class="no-padding">
            {{--<tr>--}}
                {{--<select class="selectpicker" name="devices" id="devices" title="{{ __('app.lead.devices') }}"  data-size="5">--}}
            ...
            {{--<tr>--}}
                {{--<select class="selectpicker" name="xef_kds" id="xef_kds" title="{{ __('app.lead.xefKds') }}"  data-size="5">--}}
...
<div class="grid">
    <div class="col-min33">
        <table class="no-padding">
            <tr>
                <td>Requiere venta delante cliente</td>
{{--                <td>{{ __('app.lead.retailSaleMode') }}</td>--}}
                <td>
                    <select class="selectpicker" name="retail_sale_mode_id" id="retail_sale_mode_id" title="{{ __('app.lead.retailSaleMode') }}" data-size="5">
            ...
            <tr>
                ...
                <td>
                    <select class="selectpicker" name="pos_id" id="pos_id" title="{{ __('app.lead.pos') }}" data-size="5">
            ...
            <tr>
                ...
                <td>
                    <select class="selectpicker" name="xef_pms_id" id="xef_pms_id" title="{{ __('app.lead.xefPms') }}"  data-size="5">
            ...
            <tr>
                ...
                <td>
                    <select class="selectpicker" name="erp_id" id="erp_id" title="{{ __('app.lead.erp') }}"  data-size="5">
    ...
    <div class="col-min33">
        <table class="no-padding">
            <tr>
                ...
                <td>
                <select class="selectpicker" name="retail_sale_location_id" id="retail_sale_location_id" title="{{ __('app.lead.retailSaleLocation') }}" data-size="5">
            ...
            <tr>
                ...
                <td>
                    <select class="selectpicker" name="franchise_pos_external_id" id="franchise_pos_external_id" title="{{ __('app.lead.franchisePosExternal') }}"  data-size="5">
