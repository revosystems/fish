...
<div class="section">
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group isPicker {{ $errors->has('type') ? ' is-invalid' : '' }}">
                    <label>{{ __('app.lead.type') }}: </label>
                    {{ Form::select('type', createSelectArray( \App\Models\LeadType::all()->sortBy("order"), true), $lead->type) }}
                    @if ($errors->has('type'))
            ...
            <div class="col-sm-6">
                ...
                <div class="form-group isPicker {{ $errors->has('type_segment') ? ' is-invalid' : '' }}">
                    <label>{{ __('app.lead.type_segment') }}: </label>
                    {{ Form::select('type_segment', createSelectArray( \App\Models\LeadTypesSegment::all()->sortBy("order"), true), $lead->type_segment) }}
        ...
        <div class="row dep_xef_small dep_xef_medium-large">
            <div class="col-sm-6">
                <div class="form-group isPicker {{ $errors->has('xef_typology_general') ? ' is-invalid' : '' }}">
                    <label>{{ __('app.lead.xefTypologyGeneral') }}: </label>
                    {{ Form::select('xef_typology_general', createSelectArray( \App\Models\LeadXefTypologyGeneral::all()->sortBy("order"), true), $lead->xef_typology_general) }}
            ...
            <div class="col-sm-6">
                <div class="form-group isPicker {{ $errors->has('xef_typology_specific') ? ' is-invalid' : '' }}">
                    <label>{{ __('app.lead.xefTypologySpecific') }}: </label>
                    {{ Form::select('xef_typology_specific', createSelectArray( \App\Models\LeadXefTypologySpecific::all()->sortBy("order"), true), $lead->xef_typology_specific) }}
        ...
        <div class="row dep_retail_store dep_retail_franchise">
            <div class="col-sm-12">
                <div class="form-group isPicker {{ $errors->has('retail_typology_general') ? ' is-invalid' : '' }}">
                    <label>{{ __('app.lead.retailTypologyGeneral') }}: </label>
                    {{ Form::select('retail_typology_general', createSelectArray( \App\Models\LeadRetailTypologyGeneral::all()->sortBy("order"), true), $lead->retail_typology_general) }}
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    <div class="input-group {{ $errors->has('surname1') ? ' is-invalid' : '' }}">
                        <label>{{ __('app.lead.surname1') }}: </label>
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    <div class="input-group {{ $errors->has('surname2') ? ' is-invalid' : '' }}">
                        <label>{{ __('app.lead.surname2') }}: </label>
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <div class="input-group {{ $errors->has('trade_name') ? ' is-invalid' : '' }}">
                        <label>{{ __('app.lead.trade_name') }}: </label>
            ...
            <div class="col-sm-6 col-md-6">
                <div class="form-group">
                    <div class="input-group {{ $errors->has('xef_property_quantity') ? ' is-invalid' : '' }}">
                        <label>{{ __('app.lead.xefPropertyQuantity') }}: </label>
                        <input type="text" name="xef_property_quantity" id="xef_property_quantity" value="{{ old('xef_property_quantity') ? : $lead->xef_property_quantity }}" placeholder="{{ __('app.lead.xefPropertyQuantity') }}" class="form-control" >
                    </div>
            ...
            <div class="col-sm-6 col-md-6">
                <div class="form-group">
                    <div class="input-group {{ $errors->has('xef_property_capacity') ? ' is-invalid' : '' }}">
                        <label>{{ __('app.lead.xefPropertyCapacity') }}: </label>
            ...
            <div class="col-sm-4 col-md-4">
                <div class="form-group">
                    <div class="input-group {{ $errors->has('retail_property_quantity') ? ' is-invalid' : '' }}">
                        <label>{{ __('app.lead.retailPropertyQuantity') }}: </label>
                        <input type="text" name="retail_property_quantity" id="retail_property_quantity" value="{{ old('retail_property_quantity') ? : $lead->retail_property_quantity }}" placeholder="{{ __('app.lead.retailPropertyQuantity') }}" class="form-control" >
                    </div>
            ...
            <div class="col-sm-4 col-md-4">
                <div class="form-group">
                    <div class="input-group {{ $errors->has('retail_property_staff_quantity') ? ' is-invalid' : '' }}">
                        <label>{{ __('app.lead.retailPropertyStaffQuantity') }}: </label>
        ...
        <div class="row  dep_xef_small dep_xef_medium-large dep_retail_store dep_retail_franchise">
            <div class="col-sm-12 col-md-12">
                ...
                <div class="devices_wrapper @if (old('devices') ==1) {{ 'shown' }} @endif">
                    ...
                    <div class="textarea-wrap">
                        <label>{{ __('app.lead.devicesHintPlaceholder') }}: </label>
            ...
            <div class="col-sm-4 ">
                <div class="form-group">
                    <div class="input-group {{ $errors->has('xef_pos_critical_quantity') ? ' is-invalid' : '' }}">
                        <label>{{ __('app.lead.xefPosCriticalQuantity') }}: </label>
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    <div class="input-group {{ $errors->has('xef_cash_quantity') ? ' is-invalid' : '' }}">
                        <label>{{ __('app.lead.xefCashQuantity') }}: </label>
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    <div class="input-group {{ $errors->has('xef_printers_quantity') ? ' is-invalid' : '' }}">
                        <label>{{ __('app.lead.xefPrintersQuantity') }}: </label>
            ...
            <div class="col-sm-6 col-md-6">
                ...
                @endif
                    ...
                    <div class="input-group {{ $errors->has('xef_kds_quantity') ? ' is-invalid' : '' }} hasDependancy">
                        ...
                        <label>{{ __('app.lead.xefKdsQuantity') }}: </label>
            ...
            <div class="col-sm-6 col-md-6">
                ...
                @endif
                    ...
                    <div class="input-group {{ $errors->has('xef_pms_other') ? ' is-invalid' : '' }} hasDependancy">
                        <span class="input-group-addon"><i class="fa fa-angle-double-left"></i></span>
                        <label>{{ __('app.lead.specify') }}: </label>
        ...
        <div class="row dep_xef_medium-large dep_retail_franchise">
            <div class="col-sm-6 col-md-6">
            ...
            <div class="col-sm-6 col-md-6">
                ...
                @endif
                    ...
                    <div class="input-group {{ $errors->has('erp_other') ? ' is-invalid' : '' }} hasDependancy">
                        <span class="input-group-addon"><i class="fa fa-angle-double-left"></i></span>
                        <label>{{ __('app.lead.specify') }}: </label>
                        <input type="text" name="erp_other" id="erp_other" value="{{ old('erp_other') ? : $lead->erp_other }}" placeholder="{{ __('app.lead.specify') }}" class="form-control"
                        @if (old('erp') != -1)
                            {{ 'disabled' }}
                                @endif
                        >
        ...
        <div class="row dep_xef_medium-large">
            ...
            <div class="col-sm-6 col-md-6">
                ...
                @endif
                    ...
                    <div class="input-group {{ $errors->has('xef_soft_other') ? ' is-invalid' : '' }} hasDependancy">
                        <span class="input-group-addon"><i class="fa fa-angle-double-left"></i></span>
                        <label>{{ __('app.lead.specify') }}: </label>
                        <input type="text" name="xef_soft_other" id="xef_soft_other" value="{{ old('xef_soft_other') ? : $lead->xef_soft_other }}" placeholder="{{ __('app.lead.specify') }}" class="form-control"
                        @if (old('xef_soft') != -1)
                            {{ 'disabled' }}
                                @endif
                        >
        ...
        <div class="row dep_retail_franchise">
            ...
            <div class="col-sm-6 col-md-6">
                ...
                @endif
                    ...
                    <div class="input-group {{ $errors->has('retail_soft_other') ? ' is-invalid' : '' }} hasDependancy">
                        <span class="input-group-addon"><i class="fa fa-angle-double-left"></i></span>
                        <label>{{ __('app.lead.specify') }}: </label>
                        <input type="text" name="retail_soft_other" id="retail_soft_other" value="{{ old('retail_soft_other') ? : $lead->retail_soft_other }}" placeholder="{{ __('app.lead.specify') }}" class="form-control"
                        @if (old('retail_soft') != -1)
                            {{ 'disabled' }}
                                @endif
                        >
