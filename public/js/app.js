...
function addListeners() {
  $("[data-post]").on("click", function (t) {
    ...
    return -1 === e.indexOf("confirm") || confirm(confirmDelete) ? -1 !== e.indexOf("ajax") ? (t.preventDefault(), callAjax($(this).attr("href"), {
      _method: "delete"
    })) : -1 !== e.indexOf("resource") ? (t.preventDefault(), $('<form action="' + $(this).attr("href") + '" method="POST"><input type="hidden" name="_method" value="DELETE"><input type="hidden" name="_token" value="' + csrf_token + '"></form>').appendTo("body").submit()) : void (confirm(confirmDelete) || t.preventDefault()) : t.preventDefault();
...
function callAjax(t, e) {
  -1 != window.location.href.toString().search("public") && (t = "/revo-retail/public" + t), e = e ? $.extend({}, e, {
    _token: csrf_token
  }) : {
    _token: csrf_token
  }, $.post(t, e, function () {}).done(function (t) {
...
function postSaveOrder(t, e) {
  var n = $(e).sortable("serialize");
  n = n + "&_token=" + csrf_token, console.log("Url:" + t), console.log("Serialized:" + n), $.post(t, n, function () {}).done(function (t) {
...
function showOrHideFormVisibility(t, e, n) {
  var i = n ? "fast" : 0;
  $("#" + e.field).val() == e.value ? $("#panel_" + t).hide(i) : $("#panel_" + t).show(i);
}
...
!function (t, e) {
  ...
  function n(t) {
    var e = t.length,
        n = tt.type(t);
    return "function" !== n && !tt.isWindow(t) && (!(1 !== t.nodeType || !e) || "array" === n || 0 === e || "number" == typeof e && e > 0 && e - 1 in t);
  }
  ...
  function i(t, e, n) {
    ...
    if ("string" == typeof e) {
      if (at.test(e)) return tt.filter(e, t, n);
      e = tt.filter(e, t);
    }
  ...
  function l(t, e, n) {
    var i;
    if (void 0 === n && 1 === t.nodeType) if (i = "data-" + e.replace(bt, "-$1").toLowerCase(), "string" == typeof (n = t.getAttribute(i))) {
      try {
  ...
  function b(e, n) {
    var i = tt(n.createElement(e)).appendTo(n.body),
        o = t.getDefaultComputedStyle ? t.getDefaultComputedStyle(i[0]).display : tt.css(i[0], "display");
    return i.detach(), o;
  }
  ...
  function w(t) {
    var e = J,
        n = Rt[t];
    return n || (n = b(t, e), "none" !== n && n || (Ht = (Ht || tt("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement), e = Ht[0].contentDocument, e.write(), e.close(), n = b(t, e), Ht.detach()), Rt[t] = n), n;
  }
  ...
  function _(t, e, n) {
    var i,
        ...
        r,
        a = t.style;
    return n = n || Wt(t), n && (r = n.getPropertyValue(e) || n[e]), n && ("" !== r || tt.contains(t.ownerDocument, t) || (r = tt.style(t, e)), qt.test(r) && Mt.test(e) && (i = a.width, o = a.minWidth, s = a.maxWidth, a.minWidth = a.maxWidth = a.width = r, r = n.width, a.width = i, a.minWidth = o, a.maxWidth = s)), void 0 !== r ? r + "" : r;
  }
  ...
  function A(t, e, n) {
    ...
    if (0 >= o || null == o) {
      if (o = _(t, e, s), (0 > o || null == o) && (o = t.style[e]), qt.test(o)) return o;
      i = r && (Q.boxSizingReliable() || o === t.style[e]), o = parseFloat(o) || 0;
    }
  ...
  function $(t, e, n) {
    var i,
        ...
        d = t.nodeType && xt(t),
        f = mt.get(t, "fxshow");
    n.queue || (a = tt._queueHooks(t, "fx"), null == a.unqueued && (a.unqueued = 0, l = a.empty.fire, a.empty.fire = function () {
      a.unqueued || l();
  ...
  function N(t, e, n) {
    var i,
      ...
      for (var e = Kt || k(), n = Math.max(0, c.startTime + c.duration - e), i = n / c.duration || 0, s = 1 - i, r = 0, l = c.tweens.length; l > r; r++) {
        c.tweens[r].run(s);
      }
    ...
    for (I(u, c.opts.specialEasing); r > s; s++) {
      if (i = te[s].call(c, t, u, c.opts)) return i;
    }

    return tt.map(u, O, c), tt.isFunction(c.opts.start) && c.opts.start.call(t, c), tt.fx.timer(tt.extend(l, {
      elem: t,
      anim: c,
      queue: c.opts.queue
  ...
  tt.fn = tt.prototype = {
    ...
    for ("boolean" == typeof r && (c = r, r = arguments[a] || {}, a++), "object" == (void 0 === r ? "undefined" : _typeof(r)) || tt.isFunction(r) || (r = {}), a === l && (r = this, a--); l > a; a++) {
    ...
    globalEval: function globalEval(t) {
      var e,
          n = eval;
      (t = tt.trim(t)) && (1 === t.indexOf("use strict") ? (e = J.createElement("script"), e.text = t, J.head.appendChild(e).parentNode.removeChild(e)) : n(t));
    },
    ...
    each: function each(t, e, i) {
      ...
      if (i) {
        if (r) for (; s > o && !1 !== e.apply(t[o], i); o++) {
          ;
        } else for (o in t) {
          if (!1 === e.apply(t[o], i)) break;
        }
      } else if (r) for (; s > o && !1 !== e.call(t[o], o, t[o]); o++) {
        ;
      } else for (o in t) {
    ...
    makeArray: function makeArray(t, e) {
      var i = e || [];
      return null != t && (n(Object(t)) ? tt.merge(i, "string" == typeof t ? [t] : t) : U.call(i, t)), i;
    },
    ...
    proxy: function proxy(t, e) {
      var n, i, o;
      return "string" == typeof e && (n = t[e], e = t, t = n), tt.isFunction(t) ? (i = F.call(arguments, 2), o = function o() {
  ...
  var ot = function (t) {
    function e(t, e, n, i) {
      var o, s, r, a, c, p, d, f, g, m;
      if ((e ? e.ownerDocument || e : H) !== D && k(e), e = e || D, n = n || [], !t || "string" != typeof t) return n;
      ...
      if ($ && !i) {
        if (o = mt.exec(t)) if (r = o[1]) {
          ...
          if ((r = o[3]) && _.getElementsByClassName && e.getElementsByClassName) return Q.apply(n, e.getElementsByClassName(r)), n;
        }
    ...
    function u(t, n) {
      ...
      for (a = t, l = [], c = x.preFilter; a;) {
        ...
        for (r in x.filter) {
          !(o = pt[r].exec(a)) || c[r] && !(o = c[r](o)) || (i = o.shift(), s.push({
            value: i,
            type: r,
            matches: o
          }), a = a.slice(i.length));
    ...
    function g(t, e, n, o, s, r) {
      return o && !o[z] && (o = g(o)), s && !s[z] && (s = g(s, r)), i(function (i, r, a, l) {
        var c,
            ...
            b = n ? s || (i ? t : g || o) ? [] : r : v;
        if (n && n(v, b, a, l), o) for (c = f(b, d), o(c, [], a, l), u = c.length; u--;) {
          (h = c[u]) && (b[d[u]] = !(v[d[u]] = h));
        }
      ...
      for (var e, n, i, o = t.length, s = x.relative[t[0].type], r = s || x.relative[" "], a = s ? 1 : 0, l = p(function (t) {
        ...
        if (n = x.relative[t[a].type]) u = [p(d(u), n)];else {
          if (n = x.filter[t[a].type].apply(null, t[a].matches), n[z]) {
            ...
            return g(a > 1 && d(u), a > 1 && h(t.slice(0, a - 1).concat({
              value: " " === t[a - 2].type ? "*" : ""
            })).replace(rt, "$1"), n, i > a && m(t.slice(a, i)), o > i && m(t = t.slice(i)), o > i && h(t));
          }
    ...
    function v(t, n) {
      var o = n.length > 0,
        ...
        for (c && (A = _r !== D && _r); g !== _ && null != (u = b[g]); g++) {
          if (s && u) {
            for (h = 0; p = t[h++];) {
              if (p(u, _r, a)) {
                l.push(u);
    ...
    function b(t, e, n, i) {
      ...
      if (!i && 1 === p.length) {
        if (s = p[0] = p[0].slice(0), s.length > 2 && "ID" === (r = s[0]).type && _.getById && 9 === e.nodeType && $ && x.relative[s[1].type]) {
          if (!(e = (x.find.ID(r.matches[0].replace(bt, wt), e) || [])[0])) return n;
    ...
    _ = e.support = {}, T = e.isXML = function (t) {
      ...
      var e,
          ...
          i = n.defaultView;
      return n !== D && 9 === n.nodeType && n.documentElement ? (D = n, O = n.documentElement, $ = !T(n), i && i !== i.top && (i.addEventListener ? i.addEventListener("unload", function () {
        k();
        ...
        var e = t.replace(bt, wt);
        return function (t) {
          var n = _typeof(t.getAttributeNode) !== U && t.getAttributeNode("id");
          return n && n.value === e;
        };
        ...
        return i || (i = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1, 1 & i || !_.sortDetached && e.compareDocumentPosition(t) === i ? t === n || t.ownerDocument === H && j(H, t) ? -1 : e === n || e.ownerDocument === H && j(H, e) ? 1 : E ? Z.call(E, t) - Z.call(E, e) : 0 : 4 & i ? -1 : 1);
      } : function (t, e) {
        if (t === e) return P = !0, 0;
        var i,
            o = 0,
            ...
            l = [t],
            c = [e];
        if (!s || !a) return t === n ? -1 : e === n ? 1 : s ? -1 : a ? 1 : E ? Z.call(E, t) - Z.call(E, e) : 0;
        if (s === a) return r(t, e);
      ...
      if (P = !_.detectDuplicates, E = !_.sortStable && t.slice(0), t.sort(B), P) {
        for (; e = t[o++];) {
          e === t[o] && (i = n.push(o));
        }
      ...
      preFilter: {
        ...
        PSEUDO: function PSEUDO(t) {
          var e,
              n = !t[5] && t[2];
          return pt.CHILD.test(t[0]) ? null : (t[3] && void 0 !== t[4] ? t[2] = t[4] : n && ut.test(n) && (e = u(n, !0)) && (e = n.indexOf(")", n.length - e) - n.length) && (t[0] = t[0].slice(0, e), t[2] = n.slice(0, e)), t.slice(0, 3));
        }
      },
      filter: {
        TAG: function TAG(t) {
        ...
        CHILD: function CHILD(t, e, n, i, o) {
          ...
          return 1 === i && 0 === o ? function (t) {
            ...
            if (m) {
              ...
              } else if (y && (c = (e[z] || (e[z] = {}))[t]) && c[0] === R) p = c[1];else for (; (h = ++d && h && h[g] || (p = d = 0) || f.pop()) && ((a ? h.nodeName.toLowerCase() !== v : 1 !== h.nodeType) || !++p || (y && ((h[z] || (h[z] = {}))[t] = [R, p]), h !== e));) {
                ;
              }
  ...
  tt.extend({
    ...
    tt.fn[t] = function (n, i) {
      ...
      return "Until" !== t.slice(-5) && (i = n), i && "string" == typeof i && (o = tt.filter(i, o)), this.length > 1 && (ht[t] || tt.unique(o), ut.test(t) && o.reverse()), this.pushStack(o);
    };
  });
  var pt = /\S+/g,
      dt = {};
  tt.Callbacks = function (t) {
    t = "string" == typeof t ? dt[t] || s(t) : tt.extend({}, t);
    ...
    Deferred: function Deferred(t) {
      var e = [["resolve", "done", tt.Callbacks("once memory"), "resolved"], ["reject", "fail", tt.Callbacks("once memory"), "rejected"], ["notify", "progress", tt.Callbacks("memory")]],
          ...
          return tt.Deferred(function (n) {
            tt.each(e, function (e, s) {
              ...
              o[s[1]](function () {
                ...
                t && tt.isFunction(t.promise) ? t.promise().done(n.resolve).fail(n.reject).progress(n.notify) : n[s[0] + "With"](this === i ? n.promise() : this, r ? [t] : arguments);
              });
            }), t = null;
          }).promise();
        },
        promise: function promise(t) {
          ...
          o = {};
      return i.pipe = i.then, tt.each(e, function (t, s) {
        var r = s[2],
            a = s[3];
  ...
  var gt = tt.access = function (t, e, n, i, o, s, r) {
    var a = 0,
        l = t.length,
        c = null == n;
  ...
  tt.acceptData = function (t) {
    ...
    set: function set(t, e, n) {
      var i,
          o = this.key(t),
          s = this.cache[o];
      if ("string" == typeof e) s[e] = n;else if (tt.isEmptyObject(s)) tt.extend(this.cache[o], e);else for (i in e) {
        s[i] = e[i];
      }
      return s;
    },
    ...
    remove: function remove(t, e) {
      ...
      if (void 0 === e) this.cache[s] = {};else {
        tt.isArray(e) ? i = e.concat(e.map(tt.camelCase)) : (o = tt.camelCase(e), e in r ? i = [e, o] : (i = o, i = i in r ? [i] : i.match(pt) || [])), n = i.length;
  ...
  tt.extend({
    ...
    data: function data(t, e) {
      ...
      return "object" == (void 0 === t ? "undefined" : _typeof(t)) ? this.each(function () {
        ...
        if (s && void 0 === e) {
          if (void 0 !== (n = vt.get(s, t))) return n;
          if (void 0 !== (n = vt.get(s, i))) return n;
    ...
    queue: function queue(t, e, n) {
      var i;
      return t ? (e = (e || "fx") + "queue", i = mt.get(t, e), n && (!i || tt.isArray(n) ? i = mt.access(t, e, tt.makeArray(n)) : i.push(n)), i || []) : void 0;
    },
  ...
  tt.event = {
    ...
    add: function add(t, e, n, i, o) {
      var s,
          ...
          g,
          m = mt.get(t);
      if (m) for (n.handler && (s = n, n = s.handler, o = s.selector), n.guid || (n.guid = tt.guid++), (l = m.events) || (l = m.events = {}), (r = m.handle) || (r = m.handle = function (e) {
        ...
        a = Pt.exec(e[c]) || [], d = g = a[1], f = (a[2] || "").split(".").sort(), d && (h = tt.event.special[d] || {}, d = (o ? h.delegateType : h.bindType) || d, h = tt.event.special[d] || {}, u = tt.extend({
          type: d,
          origType: g,
          data: i,
          handler: n,
          ...
          namespace: f.join(".")
        }, s), (p = l[d]) || (p = l[d] = [], p.delegateCount = 0, h.setup && !1 !== h.setup.call(t, i, f, r) || t.addEventListener && t.addEventListener(d, r, !1)), h.add && (h.add.call(t, u), u.handler.guid || (u.handler.guid = n.guid)), o ? p.splice(p.delegateCount++, 0, u) : p.push(u), tt.event.global[d] = !0);
      }
    },
    ...
    mouseHooks: {
      ...
      filter: function filter(t, e) {
        var n,
            ...
            o,
            s = e.button;
        return null == t.pageX && null != e.clientX && (n = t.target.ownerDocument || J, i = n.documentElement, o = n.body, t.pageX = e.clientX + (i && i.scrollLeft || o && o.scrollLeft || 0) - (i && i.clientLeft || o && o.clientLeft || 0), t.pageY = e.clientY + (i && i.scrollTop || o && o.scrollTop || 0) - (i && i.clientTop || o && o.clientTop || 0)), t.which || void 0 === s || (t.which = 1 & s ? 1 : 2 & s ? 3 : 4 & s ? 2 : 0), t;
      }
    },
    fix: function fix(t) {
      ...
      for (r || (this.fixHooks[o] = r = At.test(o) ? this.mouseHooks : St.test(o) ? this.keyHooks : {}), i = r.props ? this.props.concat(r.props) : this.props, t = new tt.Event(s), e = i.length; e--;) {
        n = i[e], t[n] = s[n];
      }
    ...
    simulate: function simulate(t, e, n, i) {
      var o = tt.extend(new tt.Event(), n, {
        type: t,
        isSimulated: !0,
        originalEvent: {}
      });
      i ? tt.event.trigger(o, null, e) : tt.event.dispatch.call(e, o), o.isDefaultPrevented() && n.preventDefault();
    }
    ...
    tt.event.special[t] = {
      ...
      handle: function handle(t) {
        var n,
            ...
            o = t.relatedTarget,
            s = t.handleObj;
        return (!o || o !== i && !tt.contains(i, o)) && (t.type = s.origType, n = s.handler.apply(this, arguments), t.type = e), n;
      }
    };
  }), Q.focusinBubbles || tt.each({
    focus: "focusin",
    blur: "focusout"
  }, function (t, e) {
    var n = function n(t) {
  ...
  zt.optgroup = zt.option, zt.tbody = zt.tfoot = zt.colgroup = zt.caption = zt.thead, zt.th = zt.td, tt.extend({
    clone: function clone(t, e, n) {
      ...
      if (!(Q.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || tt.isXMLDoc(t))) for (r = v(a), s = v(t), i = 0, o = s.length; o > i; i++) {
        y(s[i], r[i]);
      }
    ...
    html: function html(t) {
      return gt(this, function (t) {
        ...
        if ("string" == typeof t && !$t.test(t) && !zt[(Dt.exec(t) || ["", ""])[1].toLowerCase()]) {
          t = t.replace(kt, "<$1></$2>");
    ...
    domManip: function domManip(t, e) {
      ...
      var n,
          ...
          p = t[0],
          g = tt.isFunction(p);
      if (g || c > 1 && "string" == typeof p && !Q.checkClone && It.test(p)) return this.each(function (n) {
        var i = u.eq(n);
  ...
  !function () {
    function e() {
      r.style.cssText = "-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;padding:1px;border:1px;display:block;width:4px;margin-top:1%;position:absolute;top:1%", o.appendChild(s);
    ...
    r.style.backgroundClip = "content-box", r.cloneNode(!0).style.backgroundClip = "", Q.clearCloneStyle = "content-box" === r.style.backgroundClip, s.style.cssText = "border:0;width:0;height:0;position:absolute;top:0;left:-9999px;margin-top:1px", s.appendChild(r), t.getComputedStyle && tt.extend(Q, {
      ...
      reliableMarginRight: function reliableMarginRight() {
        var e,
            n = r.appendChild(J.createElement("div"));
  ...
  tt.extend({
    ...
    css: function css(t, e, n, i) {
      var o,
          ...
          r,
          a = tt.camelCase(e);
      return e = tt.cssProps[a] || (tt.cssProps[a] = C(t.style, a)), r = tt.cssHooks[e] || tt.cssHooks[a], r && "get" in r && (o = r.get(t, !0, n)), void 0 === o && (o = _(t, e, i)), "normal" === o && e in Xt && (o = Xt[e]), "" === n || n ? (s = parseFloat(o), !0 === n || tt.isNumeric(s) ? s || 0 : o) : o;
    }
    ...
    tt.cssHooks[e] = {
      ...
      set: function set(t, n, i) {
        var o = i && Wt(t);
        return T(t, n, i ? S(t, e, i, "border-box" === tt.css(t, "boxSizing", !1, o), o) : 0);
      }
    };
  ...
  }), tt.Tween = P, P.prototype = {
    constructor: P,
    init: function init(t, e, n, i, o, s) {
    ...
    run: function run(t) {
      ...
      return this.pos = e = this.options.duration ? tt.easing[this.easing](t, this.options.duration * t, 0, 1, this.options.duration) : t, this.now = (this.end - this.start) * e + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), n && n.set ? n.set(this) : P.propHooks._default.set(this), this;
    }
  ...
  }, tt.fx = P.prototype.init, tt.fx.step = {};
  var Kt,
      Gt,
      Qt = /^(?:toggle|show|hide)$/,
  ...
  tt.Animation = tt.extend(N, {
    ...
    var i = t && "object" == (void 0 === t ? "undefined" : _typeof(t)) ? tt.extend({}, t) : {
    ...
    finish: function finish(t) {
      return !1 !== t && (t = t || "fx"), this.each(function () {
        ...
        for (n.finish = !0, tt.queue(this, t, []), o && o.stop && o.stop.call(this, !0), e = s.length; e--;) {
  ...
  tt.fn.extend({
    ...
    attr: function attr(t, e, n) {
      var i,
          o,
          s = t.nodeType;
      if (t && 3 !== s && 8 !== s && 2 !== s) return _typeof(t.getAttribute) === Tt ? tt.prop(t, e, n) : (1 === s && tt.isXMLDoc(t) || (e = e.toLowerCase(), i = tt.attrHooks[e] || (tt.expr.match.bool.test(e) ? ne : void 0)), void 0 === n ? i && "get" in i && null !== (o = i.get(t, e)) ? o : (o = tt.find.attr(t, e), null == o ? void 0 : o) : null !== n ? i && "set" in i && void 0 !== (o = i.set(t, n, e)) ? o : (t.setAttribute(e, n + ""), n) : void tt.removeAttr(t, e));
    },
    ...
    ie[e] = function (t, e, i) {
      var o, s;
      return i || (s = ie[e], ie[e] = o, o = null != n(t, e, i) ? e.toLowerCase() : null, ie[e] = s), o;
    };
  });
  ...
  tt.fn.extend({
    ...
    prop: function prop(t, e, n) {
      var i,
          ...
          s,
          r = t.nodeType;
      if (t && 3 !== r && 8 !== r && 2 !== r) return s = 1 !== r || !tt.isXMLDoc(t), s && (e = tt.propFix[e] || e, o = tt.propHooks[e]), void 0 !== n ? o && "set" in o && void 0 !== (i = o.set(t, n, e)) ? i : t[e] = n : o && "get" in o && null !== (i = o.get(t, e)) ? i : t[e];
    },
    propHooks: {
      tabIndex: {
        get: function get(t) {
  ...
  tt.fn.extend({
    val: function val(t) {
      ...
      return arguments.length ? (i = tt.isFunction(t), this.each(function (n) {
        var o;
        1 === this.nodeType && (o = i ? t.call(this, n, tt(this).val()) : t, null == o ? o = "" : "number" == typeof o ? o += "" : tt.isArray(o) && (o = tt.map(o, function (t) {
          return null == t ? "" : t + "";
  ...
  ce = ve.exec(ue.toLowerCase()) || [], tt.extend({
    active: 0,
    lastModified: {},
    etag: {},
    ajaxSettings: {
    ...
    ajax: function ajax(t, e) {
      ...
      if (f.promise(_).complete = g.add, _.success = _.done, _.error = _.fail, h.url = ((t || h.url || ue) + "").replace(he, "").replace(me, ce[1] + "//"), h.type = e.method || e.type || h.method || h.type, h.dataTypes = tt.trim(h.dataType || "*").toLowerCase().match(pt) || [""], null == h.crossDomain && (l = ve.exec(h.url.toLowerCase()), h.crossDomain = !(!l || l[1] === ce[1] && l[2] === ce[2] && (l[3] || ("http:" === l[1] ? "80" : "443")) === (ce[3] || ("http:" === ce[1] ? "80" : "443")))), h.data && h.processData && "string" != typeof h.data && (h.data = tt.param(h.data, h.traditional)), j(ye, h, e, _), 2 === b) return _;
      c = h.global, c && 0 == tt.active++ && tt.event.trigger("ajaxStart"), h.type = h.type.toUpperCase(), h.hasContent = !ge.test(h.type), o = h.url, h.hasContent || (h.data && (o = h.url += (le.test(o) ? "&" : "?") + h.data, delete h.data), !1 === h.cache && (h.url = pe.test(o) ? o.replace(pe, "$1_=" + ae++) : o + (le.test(o) ? "&" : "?") + "_=" + ae++)), h.ifModified && (tt.lastModified[o] && _.setRequestHeader("If-Modified-Since", tt.lastModified[o]), tt.etag[o] && _.setRequestHeader("If-None-Match", tt.etag[o])), (h.data && h.hasContent && !1 !== h.contentType || e.contentType) && _.setRequestHeader("Content-Type", h.contentType), _.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + we + "; q=0.01" : "") : h.accepts["*"]);

      for (u in h.headers) {
        _.setRequestHeader(u, h.headers[u]);
      }

      if (h.beforeSend && (!1 === h.beforeSend.call(p, _, h) || 2 === b)) return _.abort();
      w = "abort";
    ...
    tt[e] = function (t, n, i, o) {
      return tt.isFunction(n) && (o = o || i, i = n, n = void 0), tt.ajax({
        url: t,
        type: e,
        dataType: o,
        data: n,
  ...
  tt.param = function (t, e) {
    ...
    serializeArray: function serializeArray() {
      return this.map(function () {
        ...
        var t = this.type;
        return this.name && !tt(this).is(":disabled") && Se.test(this.nodeName) && !Te.test(t) && (this.checked || !Ct.test(t));
      }).map(function (t, e) {
        var n = tt(this).val();
  ...
  t.ActiveXObject && tt(t).on("unload", function () {
    ...
    return Q.cors || ke && !t.crossDomain ? {
      send: function send(n, i) {
        var o,
            s = t.xhr(),
            r = ++Ae;
        if (s.open(t.type, t.url, t.async, t.username, t.password), t.xhrFields) for (o in t.xhrFields) {
          s[o] = t.xhrFields[o];
        }
        ...
        _e3 = function e(t) {
          return function () {
            _e3 && (delete Ee[r], _e3 = s.onload = s.onerror = null, "abort" === t ? s.abort() : "error" === t ? i(s.status, s.statusText) : i(Pe[s.status] || s.status, s.statusText, "string" == typeof s.responseText ? {
              text: s.responseText
  ...
  tt.ajaxSetup({
    ...
    var o,
        s,
        r,
        a = !1 !== e.jsonp && (Oe.test(e.url) ? "url" : "string" == typeof e.data && !(e.contentType || "").indexOf("application/x-www-form-urlencoded") && Oe.test(e.data) && "data");
    return a || "jsonp" === e.dataTypes[0] ? (o = e.jsonpCallback = tt.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(Oe, "$1" + o) : !1 !== e.jsonp && (e.url += (le.test(e.url) ? "&" : "?") + e.jsonp + "=" + o), e.converters["script json"] = function () {
    ...
    var i = rt.exec(t),
        o = !n && [];
    return i ? [e.createElement(i[1])] : (i = tt.buildFragment([t], e, o), o && o.length && tt(o).remove(), tt.merge([], i.childNodes));
  };
  var $e = tt.fn.load;
  tt.fn.load = function (t, e, n) {
    ...
    var i,
        ...
        r = this,
        a = t.indexOf(" ");
    return a >= 0 && (i = t.slice(a), t = t.slice(0, a)), tt.isFunction(e) ? (n = e, e = void 0) : e && "object" == (void 0 === e ? "undefined" : _typeof(e)) && (o = "POST"), r.length > 0 && tt.ajax({
      url: t,
      type: o,
      dataType: "html",
      data: e
  ...
  tt.offset = {
    ...
    offset: function offset(t) {
      ...
      var e,
        ...
        left: 0
          ...
          s = i && i.ownerDocument;
      return s ? (e = s.documentElement, tt.contains(e, i) ? (_typeof(i.getBoundingClientRect) !== Tt && (o = i.getBoundingClientRect()), n = q(s), {
    ...
    tt.fn[e] = function (o) {
      return gt(this, function (e, o, s) {
        var r = q(e);
        return void 0 === s ? r ? r[n] : e[o] : void (r ? r.scrollTo(i ? t.pageXOffset : s, i ? s : t.pageYOffset) : e[o] = s);
    ...
    tt.each({
      ...
      tt.fn[i] = function (i, o) {
        ...
        return gt(this, function (e, n, i) {
          var o;
          return tt.isWindow(e) ? e.document.documentElement["client" + t] : 9 === e.nodeType ? (o = e.documentElement, Math.max(e.body["scroll" + t], o["scroll" + t], e.body["offset" + t], o["offset" + t], o["client" + t])) : void 0 === i ? tt.css(e, n, r) : tt.style(e, n, i, r);
        }, e, s ? i : void 0, s, null);
      };
    });
  }), tt.fn.size = function () {
  ...
  function n(e, n) {
    ...
    return "area" === a ? (o = e.parentNode, s = o.name, !(!e.href || !s || "map" !== o.nodeName.toLowerCase()) && !!(r = t("img[usemap=#" + s + "]")[0]) && i(r)) : (/input|select|textarea|button|object/.test(a) ? !e.disabled : "a" === a ? e.href || n : n) && i(e);
  }
  ...
  t.ui = t.ui || {}, t.extend(t.ui, {
    ...
    zIndex: function zIndex(n) {
      ...
      if (this.length) for (var i, o, s = t(this[0]); s.length && s[0] !== document;) {
        if (("absolute" === (i = s.css("position")) || "relative" === i || "fixed" === i) && (o = parseInt(s.css("zIndex"), 10), !isNaN(o) && 0 !== o)) return o;
        s = s.parent();
      }
      return 0;
    },
    ...
    plugin: {
      ...
      call: function call(t, e, n) {
        var i,
            o = t.plugins[e];
        if (o && t.element[0].parentNode && 11 !== t.element[0].parentNode.nodeType) for (i = 0; o.length > i; i++) {
  ...
  t.cleanData = function (e) {
    ...
    var s,
        ...
        c = {},
        u = n.split(".")[0];
    n = n.split(".")[1], s = u + "-" + n, o || (o = i, i = t.Widget), t.expr[":"][s.toLowerCase()] = function (e) {
      return !!t.data(e, s);
      ...
      return t.isFunction(o) ? (c[n] = function () {
        ...
        return function () {
          var n,
              i = this._super,
              s = this._superApply;
          return this._super = t, this._superApply = e, n = o.apply(this, arguments), this._super = i, this._superApply = s, n;
        };
      }(), e) : (c[n] = o, e);
    }), a.prototype = t.widget.extend(l, {
      widgetEventPrefix: r ? l.widgetEventPrefix || n : n
    }, c, {
      constructor: a,
      namespace: u,
      widgetName: n,
    ...
    t.fn[n] = function (r) {
      ...
      return r = !a && l.length ? t.widget.extend.apply(null, [r].concat(l)) : r, a ? this.each(function () {
        var i,
            o = t.data(this, s);
        return o ? t.isFunction(o[r]) && "_" !== r.charAt(0) ? (i = o[r].apply(o, l), i !== o && i !== e ? (c = i && i.jquery ? c.pushStack(i.get()) : i, !1) : e) : t.error("no such method '" + r + "' for " + n + " widget instance") : t.error("cannot call methods on " + n + " prior to initialization; attempted to call method '" + r + "'");
      }) : this.each(function () {
        var e = t.data(this, s);
    ...
    _on: function _on(n, i, o) {
      var s,
          r = this;
      "boolean" != typeof n && (o = i, i = n, n = !1), o ? (i = s = t(i), this.bindings = this.bindings.add(i)) : (o = i, i = this.element, s = this.widget()), t.each(o, function (o, a) {
        function l() {
    ...
    _trigger: function _trigger(e, n, i) {
      var o,
          s,
          r = this.options[e];
      if (i = i || {}, n = t.Event(n), n.type = (e === this.widgetEventPrefix ? e : this.widgetEventPrefix + e).toLowerCase(), n.target = this.element[0], s = n.originalEvent) for (o in s) {
        o in n || (n[o] = s[o]);
      }
  ...
  t.position = {
    scrollbarWidth: function scrollbarWidth() {
      ...
      var e,
          ...
          o = i.children()[0];
      return t("body").append(i), e = o.offsetWidth, i.css("overflow", "scroll"), n = o.offsetWidth, e === n && (n = i[0].clientWidth), i.remove(), s = e - n;
    },
    ...
    return y = o(b), b[0].preventDefault && (e.at = "left top"), d = y.width, g = y.height, m = y.offset, v = t.extend({}, m), t.each(["my", "at"], function () {
      var t,
          n,
          i = (e[this] || "").split(" ");
      1 === i.length && (i = c.test(i[0]) ? i.concat(["center"]) : u.test(i[0]) ? ["center"].concat(i) : ["center", "center"]), i[0] = c.test(i[0]) ? i[0] : "center", i[1] = u.test(i[1]) ? i[1] : "center", t = h.exec(i[0]), n = h.exec(i[1]), C[this] = [t ? t[0] : 0, n ? n[0] : 0], e[this] = [p.exec(i[0])[0], p.exec(i[1])[0]];
      ...
      var o,
          ...
          A = t.extend({}, v),
          E = n(C.my, u.outerWidth(), u.outerHeight());

      "right" === e.my[0] ? A.left -= h : "center" === e.my[0] && (A.left -= h / 2), "bottom" === e.my[1] ? A.top -= p : "center" === e.my[1] && (A.top -= p / 2), A.left += E[0], A.top += E[1], t.support.offsetFractions || (A.left = l(A.left), A.top = l(A.top)), o = {
        marginLeft: f,
        marginTop: y
      }, t.each(["left", "top"], function (n, i) {
        t.ui.position[x[n]] && t.ui.position[x[n]][i](A, {
          targetWidth: d,
          targetHeight: g,
          elemWidth: h,
          elemHeight: p,
    ...
    fit: {
      left: function left(t, e) {
        ...
        e.collisionWidth > s ? l > 0 && 0 >= c ? (n = t.left + l + e.collisionWidth - s - o, t.left += l - n) : t.left = c > 0 && 0 >= l ? o : l > c ? o + s - e.collisionWidth : o : l > 0 ? t.left += l : c > 0 ? t.left -= c : t.left = r(t.left - a, t.left);
      },
      top: function top(t, e) {
        ...
        e.collisionHeight > s ? l > 0 && 0 >= c ? (n = t.top + l + e.collisionHeight - s - o, t.top += l - n) : t.top = c > 0 && 0 >= l ? o : l > c ? o + s - e.collisionHeight : o : l > 0 ? t.top += l : c > 0 ? t.top -= c : t.top = r(t.top - a, t.top);
      }
    },
    flip: {
      left: function left(t, e) {
        var n,
            ...
            f = -2 * e.offset[0];
        0 > u ? (0 > (n = t.left + p + d + f + e.collisionWidth - r - s) || a(u) > n) && (t.left += p + d + f) : h > 0 && ((i = t.left - e.collisionPosition.marginLeft + p + d + f - l) > 0 || h > a(i)) && (t.left += p + d + f);
      },
      top: function top(t, e) {
        var n,
            i,
            ...
            g = -2 * e.offset[1];
        0 > u ? (i = t.top + d + f + g + e.collisionHeight - r - s, t.top + d + f + g > u && (0 > i || a(u) > i) && (t.top += d + f + g)) : h > 0 && (n = t.top - e.collisionPosition.marginTop + d + f + g - l, t.top + d + f + g > h && (n > 0 || h > a(n)) && (t.top += d + f + g));
      }
    },
    flipfit: {
      left: function left() {
  ...
  t.widget("ui.draggable", t.ui.mouse, {
    ...
    _mouseCapture: function _mouseCapture(e) {
      var n = this.options;
      return !(this.helper || n.disabled || t(e.target).closest(".ui-resizable-handle").length > 0) && (this.handle = this._getHandle(e), !!this.handle && (t(!0 === n.iframeFix ? "iframe" : n.iframeFix).each(function () {
    ...
    _mouseStart: function _mouseStart(e) {
      ...
      }), this.originalPosition = this.position = this._generatePosition(e), this.originalPageX = e.pageX, this.originalPageY = e.pageY, n.cursorAt && this._adjustOffsetFromHelper(n.cursorAt), this._setContainment(), !1 === this._trigger("start", e) ? (this._clear(), !1) : (this._cacheHelperProportions(), t.ui.ddmanager && !n.dropBehaviour && t.ui.ddmanager.prepareOffsets(this, e), this._mouseDrag(e, !0), t.ui.ddmanager && t.ui.ddmanager.dragStart(this, e), !0);
    },
    ...
    drag: function drag(e, n) {
      ...
      for (h = d.snapElements.length - 1; h >= 0; h--) {
        ...
        })), d.snapElements[h].snapping = !1) : ("inner" !== f.snapMode && (i = g >= Math.abs(c - b), o = g >= Math.abs(u - y), s = g >= Math.abs(a - v), r = g >= Math.abs(l - m), i && (n.position.top = d._convertPositionTo("relative", {
          top: c - d.helperProportions.height,
          left: 0
        }).top - d.margins.top), o && (n.position.top = d._convertPositionTo("relative", {
          top: u,
          left: 0
        }).top - d.margins.top), s && (n.position.left = d._convertPositionTo("relative", {
          top: 0,
          left: a - d.helperProportions.width
        }).left - d.margins.left), r && (n.position.left = d._convertPositionTo("relative", {
          top: 0,
          left: l
        }).left - d.margins.left)), p = i || o || s || r, "outer" !== f.snapMode && (i = g >= Math.abs(c - y), o = g >= Math.abs(u - b), s = g >= Math.abs(a - m), r = g >= Math.abs(l - v), i && (n.position.top = d._convertPositionTo("relative", {
          top: c,
          left: 0
        }).top - d.margins.top), o && (n.position.top = d._convertPositionTo("relative", {
        ...
        }).left - d.margins.left)), !d.snapElements[h].snapping && (i || o || s || r || p) && d.options.snap.snap && d.options.snap.snap.call(d.element, e, t.extend(d._uiHash(), {
          snapItem: d.snapElements[h].item
        })), d.snapElements[h].snapping = i || o || s || r || p);
      }
    }
  ...
  t.widget("ui.droppable", {
    ...
    switch (i) {
      case "fit":
        return r >= u && p >= l && a >= h && d >= c;

      case "intersect":
        return r + t.helperProportions.width / 2 > u && p > l - t.helperProportions.width / 2 && a + t.helperProportions.height / 2 > h && d > c - t.helperProportions.height / 2;

      case "pointer":
        return o = (t.positionAbs || t.position.absolute).left + (t.clickOffset || t.offset.click).left, s = (t.positionAbs || t.position.absolute).top + (t.clickOffset || t.offset.click).top, e(s, h, n.proportions().height) && e(o, u, n.proportions().width);

      case "touch":
        return (a >= h && d >= a || c >= h && d >= c || h > a && c > d) && (r >= u && p >= r || l >= u && p >= l || u > r && l > p);
    ...
    prepareOffsets: function prepareOffsets(e, n) {
      var i,
          o,
  ...
  t.widget("ui.resizable", t.ui.mouse, {
    ...
    _create: function _create() {
      ...
      if (this.element.addClass("ui-resizable"), t.extend(this, {
        ...
        ne: ".ui-resizable-ne",
        nw: ".ui-resizable-nw"
      } : "e,s,se"), this.handles.constructor === String) for ("all" === this.handles && (this.handles = "n,e,s,w,se,sw,ne,nw"), e = this.handles.split(","), this.handles = {}, n = 0; e.length > n; n++) {
        i = t.trim(e[n]), s = "ui-resizable-" + i, o = t("<div class='ui-resizable-handle " + s + "'></div>"), o.css({
          zIndex: a.zIndex
    ...
    _mouseStart: function _mouseStart(n) {
      ...
      return this.resizing = !0, /absolute/.test(l.css("position")) ? l.css({
        ...
        top: a.top,
        left: a.left
      }), this._renderProxy(), i = e(this.helper.css("left")), o = e(this.helper.css("top")), r.containment && (i += t(r.containment).scrollLeft() || 0, o += t(r.containment).scrollTop() || 0), this.offset = this.helper.offset(), this.position = {
        left: i,
        top: o
        ...
        left: n.pageX,
        top: n.pageY
      }, this.aspectRatio = "number" == typeof r.aspectRatio ? r.aspectRatio : this.originalSize.width / this.originalSize.height || 1, s = t(".ui-resizable-" + this.axis).css("cursor"), t("body").css("cursor", "auto" === s ? this.axis + "-resize" : s), l.addClass("ui-resizable-resizing"), this._propagate("start", n), !0;
    },
    ...
    _mouseStop: function _mouseStop(e) {
      ...
      var n,
          ...
          c = this.options,
          u = this;
      return this._helper && (n = this._proportionallyResizeElements, i = n.length && /textarea/i.test(n[0].nodeName), o = i && t.ui.hasScroll(n[0], "left") ? 0 : u.sizeDiff.height, s = i ? 0 : u.sizeDiff.width, r = {
    ...
    _updateVirtualBoundaries: function _updateVirtualBoundaries(t) {
      ...
      }, (this._aspectRatio || t) && (e = r.minHeight * this.aspectRatio, o = r.minWidth / this.aspectRatio, i = r.maxHeight * this.aspectRatio, s = r.maxWidth / this.aspectRatio, e > r.minWidth && (r.minWidth = e), o > r.minHeight && (r.minHeight = o), r.maxWidth > i && (r.maxWidth = i), r.maxHeight > s && (r.maxHeight = s)), this._vBoundaries = r;
    },
    ...
    _respectSize: function _respectSize(t) {
      var e = this._vBoundaries,
          ...
          u = /sw|nw|w/.test(i),
          h = /nw|ne|n/.test(i);
      return r && (t.width = e.minWidth), a && (t.height = e.minHeight), o && (t.width = e.maxWidth), s && (t.height = e.maxHeight), r && u && (t.left = l - e.minWidth), o && u && (t.left = l - e.maxWidth), a && h && (t.top = c - e.minHeight), s && h && (t.top = c - e.maxHeight), t.width || t.height || t.left || !t.top ? t.width || t.height || t.top || !t.left || (t.left = null) : t.top = null, t;
    },
    ...
    _change: {
      e: function e(t, _e4) {
        return {
          width: this.originalSize.width + _e4
        };
      },
      w: function w(t, e) {
      ...
      n: function n(t, e, _n2) {
        ...
        return {
          top: this.originalPosition.top + _n2,
          height: i.height - _n2
        };
      },
      s: function s(t, e, n) {
    ...
    start: function start() {
      var n,
          ...
          h = c.element,
          p = u.containment,
          d = p instanceof t ? p.get(0) : /parent/.test(p) ? h.parent().get(0) : p;
      d && (c.containerElement = t(d), /document/.test(p) || p === document ? (c.containerOffset = {
        left: 0,
        top: 0
      }, c.containerPosition = {
        left: 0,
      ...
      }) : (n = t(d), i = [], t(["Top", "Right", "Left", "Bottom"]).each(function (t, o) {
      ...
      }, o = c.containerOffset, s = c.containerSize.height, r = c.containerSize.width, a = t.ui.hasScroll(d, "left") ? d.scrollWidth : r, l = t.ui.hasScroll(d) ? d.scrollHeight : s, c.parentData = {
        element: d,
        left: o.left,
        top: o.top,
        width: a,
      ...
      var i = t(this).data("ui-resizable"),
        ...
        t(e).each(function () {
          var e = t(this),
              ...
              s = {},
              r = i && i.length ? i : e.parents(n.originalElement[0]).length ? ["width", "height"] : ["width", "height", "top", "left"];
    ...
    _mouseDrag: function _mouseDrag(e) {
      if (this.dragged = !0, !this.options.disabled) {
        var n,
            ...
            a = e.pageX,
            l = e.pageY;
        return s > a && (n = a, a = s, s = n), r > l && (n = l, l = r, r = n), this.helper.css({
          left: s,
          top: r,
          width: a - s,
          height: l - r
  ...
  t.widget("ui.sortable", t.ui.mouse, {
    ...
    _intersectsWithSides: function _intersectsWithSides(t) {
      ...
      return this.floating && s ? "right" === s && i || "left" === s && !i : o && ("down" === o && n || "up" === o && !n);
    },
    ...
    _getItemsAsjQuery: function _getItemsAsjQuery(e) {
      ...
      }) : t(this.options.items, this.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"), this]), i = l.length - 1; i >= 0; i--) {
        l[i][0].each(n);
      }
    ...
    _refreshItems: function _refreshItems(e) {
      ...
      if (p && this.ready) for (n = p.length - 1; n >= 0; n--) {
        for (o = t(p[n]), i = o.length - 1; i >= 0; i--) {
          (s = t.data(o[i], this.widgetFullName)) && s !== this && !s.options.disabled && (h.push([t.isFunction(s.options.items) ? s.options.items.call(s.element[0], e, {
            item: this.currentItem
      ...
      for (n = h.length - 1; n >= 0; n--) {
        for (r = h[n][1], a = h[n][0], i = 0, c = a.length; c > i; i++) {
          l = t(a[i]), l.data(this.widgetName + "-item", r), u.push({
            item: l,
            instance: r,
            width: 0,
            height: 0,
...
$(document).ready(function () {
  setupFormLoadingImage(), $("#popup").popup({
    scrolllock: !0,
    blur: !0,
    transition: "all 0.3s"
  }), $(".sortable").sortable({
  ...
  t.fn.searcher = function (e, n) {
    ...
    this.on("keyup", function () {
      ...
      o = setTimeout(function () {
        var o = n.val();
        o.length >= i.minChars ? (i.updateAddressBar && window.history.pushState("", "", "?search=" + o), t("#" + i.resultsDiv).show(), t("#" + i.allDiv).hide(), t("#" + i.resultsDiv).load(e + n.val().replace(new RegExp(" ", "g"), "%20"), i.onFound)) : (i.updateAddressBar && window.history.pushState("", "", "?"), t("#" + i.resultsDiv).hide(), t("#" + i.allDiv).show());
      }, 300);
    });
  };
}(jQuery), function (t) {
    ...
    return function () {
        ...
        !function (e) {
          ...
          function r(t, n) {
            return function () {
              ...
              return "string" != typeof i[0] && 1 === i.length && i.push(null), _f.apply(e, i.concat([t, n]));
            };
          }
          ...
          g = function g(t, e) {
            ...
            var a,
                ...
                _,
                x = [],
                C = void 0 === i ? "undefined" : _typeof(i);

            if (s = s || t, b = h(s), "undefined" === C || "function" === C) {
              for (n = !n.length && i.length ? ["require", "exports", "module"] : n, f = 0; f < n.length; f += 1) {
                if (d = g(n[f], b), "require" === (u = d.f)) x[f] = m.require(t);else if ("exports" === u) x[f] = m.exports(t), _ = !0;else if ("module" === u) a = x[f] = m.module(t);else if (o(v, u) || o(y, u) || o(w, u)) x[f] = c(u);else {
                  ...
                  d.p.load(d.n, r(s, !0), l(u), {}), x[f] = v[u];
                }
              }
            ...
            if (!t.splice) {
              if (b = t, b.deps && _f(b.deps, b.callback), !n) return;
      ...
      return e.Extend(n, e.Observable), n.prototype.render = function () {
        ...
        this.data.current(function (i) {
          ...
          n.$results.find(".select2-results__option[aria-selected]").each(function () {
            var n = t(this),
                ...
                s = "" + i.id;
            null != i.element && i.element.selected || null == i.element && t.inArray(s, o) > -1 ? n.attr("aria-selected", "true") : n.attr("aria-selected", "false");
          });
        });
        ...
        if (n.children) {
          ...
          d.append(c), a.append(l), a.append(d);
        ...
        var o = this,
            s = n.id + "-results";
        this.$results.attr("id", s), n.on("results:all", function (t) {
          ...
          if (!(i >= e.length)) {
            ...
            var r = o.$results.offset().top + o.$results.outerHeight(!1),
                ...
                l = o.$results.scrollTop() + a - r;
            0 === i ? o.$results.scrollTop(0) : a > r && o.$results.scrollTop(l);
          }
          ...
          var e = o.$results.scrollTop(),
              ...
              s = t.deltaY < 0 && n <= o.$results.height();
          i ? (o.$results.scrollTop(0), t.preventDefault(), t.stopPropagation()) : s && (o.$results.scrollTop(o.$results.get(0).scrollHeight - o.$results.height()), t.preventDefault(), t.stopPropagation());
        ...
        if (this.clear(), 0 !== t.length) {
          for (var e = [], i = 0; i < t.length; i++) {
            var o = t[i],
                ...
                r = this.display(o, s);
            s.append(r), s.attr("title", o.title || o.text), n.StoreData(s[0], "data", o), e.push(s);
          }
      ...
      return i.prototype.render = function (e) {
        ...
        this.$selection.on("input.searchcheck", ".select2-search--inline", function (t) {
          ...
          if (a && "input" === t.type) return void s.$selection.off("input.search input.searchcheck");
          var e = t.which;
          e != n.SHIFT && e != n.CTRL && e != n.ALT && e != n.TAB && s.handleSearch(t);
        });
      ...
      return e.Extend(i, t), i.prototype.current = function (t) {
        ...
        return s.element = i, e.StoreData(i, "data", s), o;
        ...
        if (t.is("option")) i = {
          ...
          for (var o = t.children("option"), s = [], r = 0; r < o.length; r++) {
            var a = n(o[r]),
                l = this.item(a);
            s.push(l);
          }
      ...
      return k.prototype.apply = function (h) {
        if (h = t.extend(!0, {}, this.defaults, h), null == h.dataAdapter) {
          if (null != h.ajax ? h.dataAdapter = f : null != h.data ? h.dataAdapter = d : h.dataAdapter = p, h.minimumInputLength > 0 && (h.dataAdapter = c.Decorate(h.dataAdapter, v)), h.maximumInputLength > 0 && (h.dataAdapter = c.Decorate(h.dataAdapter, y)), h.maximumSelectionLength > 0 && (h.dataAdapter = c.Decorate(h.dataAdapter, b)), h.tags && (h.dataAdapter = c.Decorate(h.dataAdapter, g)), null == h.tokenSeparators && null == h.tokenizer || (h.dataAdapter = c.Decorate(h.dataAdapter, m)), null != h.query) {
            var P = e(h.amdBase + "compat/query");
            h.dataAdapter = c.Decorate(h.dataAdapter, P);
          }

          if (null != h.initSelection) {
            var k = e(h.amdBase + "compat/initSelection");
            h.dataAdapter = c.Decorate(h.dataAdapter, k);
          }
        }
        ...
        if (null == h.selectionAdapter) {
          if (h.multiple ? h.selectionAdapter = o : h.selectionAdapter = i, null != h.placeholder && (h.selectionAdapter = c.Decorate(h.selectionAdapter, s)), h.allowClear && (h.selectionAdapter = c.Decorate(h.selectionAdapter, r)), h.multiple && (h.selectionAdapter = c.Decorate(h.selectionAdapter, a)), null != h.containerCssClass || null != h.containerCss || null != h.adaptContainerCssClass) {
            var $ = e(h.amdBase + "compat/containerCss");
            h.selectionAdapter = c.Decorate(h.selectionAdapter, $);
          }
        ...
        if (t.isArray(h.language)) {
          ...
          for (var j = h.language, z = 0; z < j.length; z++) {
            var H = j[z],
                R = {};
  ...
  var n = t.document,
      i = t.location,
      o = t.escape("scrollPosition|" + i.pathname + i.search);
  t.loadScroll = function () {
    var e;
    ...
    for (e = e || [], i = e.length - 1; 0 <= i; i--) {
      ...
      try {
        if ("" == s[0]) t.scrollTo(s[1], s[2]);else if (s[0]) {
          var a = n.getElementById(s[0]);
          a.scrollLeft = s[1], a.scrollTop = s[2];
        }
      } catch (t) {}
    }
    ...
    for (t.pageXOffset !== e ? (i = t.pageXOffset, s = t.pageYOffset) : n.documentElement && n.documentElement.scrollLeft !== e ? (i = n.documentElement.scrollLeft, s = n.documentElement.scrollTop) : (i = n.body.scrollLeft, s = n.body.scrollTop), (i || s) && r.push(["", i, s].join()), i = n.all || n.getElementsByTagName("*"), s = 0; s < i.length; s++) {
      var a = i[s];
      a.id && (a.scrollLeft || a.scrollTop) && r.push([a.id, a.scrollLeft, a.scrollTop].join());
    }
  ...
  var e, n;
  t.attachEvent ? (e = t.attachEvent, n = "on") : (e = t.addEventListener, n = ""), e(n + "load", t.loadScroll, !1), e(n + "unload", t.saveScroll, !1);
}(window), setTimeout(function () {
  if ("undefined" != typeof Sys && void 0 !== Sys.WebForms) {
    var t = Sys.WebForms.PageRequestManager.getInstance();
    t.add_beginRequest(window.saveScroll), t.add_endRequest(window.loadScroll);
  }
}, 0), function (t, e) {
  ...
  return function (t) {
    ...
    t.exports = {
      ...
      cloneDeep: function cloneDeep(t) {
        var e = this.mixin({}, t),
            n = this;
        return this.each(e, function (t, i) {
      ...
      every: function every(t, e) {
        var n = !0;
        return t ? (this.each(t, function (i, o) {
      ...
      escapeHighlightedString: function escapeHighlightedString(t, e, n) {
        ...
        o.appendChild(document.createTextNode(e)), n = n || "</em>";
        var s = document.createElement("div");
        s.appendChild(document.createTextNode(n));
        var r = document.createElement("div");
        return r.appendChild(document.createTextNode(t)), r.innerHTML.replace(RegExp(i(o.innerHTML), "g"), e).replace(RegExp(i(s.innerHTML), "g"), n);
      }
    };
  }, function (t, e, n) {
    "use strict";
    ...
    function i(t, e) {
      var i = n(3),
          o = this;
      "function" == typeof Error.captureStackTrace ? Error.captureStackTrace(this, this.constructor) : o.stack = new Error().stack || "Cannot get a stacktrace, browser is too old", this.name = "AlgoliaSearchError", this.message = t || "Unknown error", e && i(e, function (t, e) {
        o[e] = t;
      });
    }
    ...
    (function (i) {
      ...
      function l() {
        ...
        return !t && void 0 !== i && "env" in i && (t = n.i({
          NODE_ENV: "production"
        }).DEBUG), t;
      }
    ...
    i.isMsie() && i.mixin(o.input, {
      backgroundImage: "url(data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7)"
    }), i.isMsie() && i.isMsie() <= 7 && i.mixin(o.input, {
      marginTop: "-1px"
    }), t.exports = o;
  }, function (t, e, n) {
    "use strict";
    ...
    function i(t, e, n, i) {
      ...
      for (e = e.split(h), n = i ? c(n, i) : n, this._callbacks = this._callbacks || {}; o = e.shift();) {
    ...
    function a(t) {
      ...
      for (t = t.split(h), i = [].slice.call(arguments, 1); (e = t.shift()) && (n = this._callbacks[e]);) {
    ...
    function n(t, e) {
      if (e = e || {}, void 0 === t) throw new Error(r);
      var n = !0 === e.prepend ? "prepend" : "append",
          a = void 0 !== e.container ? e.container : document.querySelector("head"),
          l = o.indexOf(a);
      -1 === l && (l = o.push(a) - 1, s[l] = {});
      var c;
      return void 0 !== s[l] && void 0 !== s[l][n] ? c = s[l][n] : (c = s[l][n] = i(), "prepend" === n ? a.insertBefore(c, a.childNodes[0]) : a.appendChild(c)), 65279 === t.charCodeAt(0) && (t = t.substr(1, t.length)), c.styleSheet ? c.styleSheet.cssText += t : c.textContent += t, c;
    }
    ...
    var o = [],
        s = [],
        r = "insert-css: You need to provide a CSS string. Usage: insertCss(cssString[, options]).";
    ...
    function i(t, e) {
      return function (n, i, s) {
        if ("function" == typeof n && "object" == (void 0 === i ? "undefined" : _typeof(i)) || "object" == (void 0 === s ? "undefined" : _typeof(s))) throw new o.AlgoliaSearchError("index.search usage is index.search(query, params, cb)");
        0 === arguments.length || "function" == typeof n ? (s = n, n = "") : 1 !== arguments.length && "function" != typeof i || (s = i, i = void 0), "object" == (void 0 === n ? "undefined" : _typeof(n)) && null !== n ? (i = n, n = void 0) : void 0 !== n && null !== n || (n = "");
        var r = "";
        void 0 !== n && (r += t + "=" + encodeURIComponent(n));
        var a;
        return void 0 !== i && (i.additionalUA && (a = i.additionalUA, delete i.additionalUA), r = this.as._getSearchParams(i, r)), this._search(r, e, s, a);
      };
    }
    ...
    function s(t) {
      var e = t.algoliasearch,
        ...
        throw t;
          ...
          P = t.type,
          k = e.initPlaces(s, i, n);
      k.as.addAlgoliaAgent("Algolia Places " + u.default);
      var D = {
        countries: g,
        hitsPerPage: a || 5,
        language: x,
      ...
      Array.isArray(D.countries) && (D.countries = D.countries.map(function (t) {
        return t.toLowerCase();
      })), "string" == typeof D.language && (D.language = D.language.toLowerCase()), c ? D.aroundLatLng = c : void 0 !== p && (D.aroundLatLngViaIP = p), h && (D.aroundRadius = h), d && (D.insideBoundingBox = d), f && (D.insidePolygon = f);
      var O = void 0;
      return w && navigator.geolocation.watchPosition(function (t) {
        var e = t.coords;
        O = e.latitude + "," + e.longitude;
      }), function (t, e) {
        var n;
        return k.search(y(r({}, D, (n = {}, o(n, O ? "aroundLatLng" : void 0, O), o(n, "query", t), n)))).then(function (e) {
    ...
    function o(t) {
      for (var e = t[0].value, n = [], i = 1; i < t.length; ++i) {
        "none" !== t[i].matchLevel && n.push({
          index: i,
          words: t[i].matchedWords
        });
      }
    ...
    function s(t) {
      ...
      try {
        var c = n.locale_names[0],
            ...
            m = {
          name: o(n._highlightResult.locale_names),
          city: d ? o(n._highlightResult.city) : void 0,
          administrative: p ? o(n._highlightResult.administrative) : void 0,
          country: h ? n._highlightResult.country.value : void 0,
          suburb: f ? o(n._highlightResult.suburb) : void 0,
          county: g ? o(n._highlightResult.county) : void 0
        },
            v = {
          name: c,
          administrative: p,
          ...
          suburb: f,
          country: h,
          countryCode: (0, l.default)(n._tags),
          type: (0, u.default)(n._tags),
          latlng: {
            lat: n._geoloc.lat,
            lng: n._geoloc.lng
          },
    ...
    function i(t) {
      var e = t.administrative,
          n = t.city,
          i = t.country;
      return (t.name + ("country" !== t.type && void 0 !== i ? "," : "") + "\n " + (n ? n + "," : "") + "\n " + (e ? e + "," : "") + "\n " + (i || "")).replace(/\s*\n\s*/g, " ").trim();
    }
    ...
    function o(t) {
      ...
      var u = new a.default(),
        ...
        onRateLimitReached: function onRateLimitReached() {
          if (0 === u.listenerCount("limit")) return void console.log(C.default.rateLimitReached);
          u.emit("limit", {
      ...
      w.setAttribute("type", "button"), w.setAttribute("aria-label", "clear"), w.classList.add(p + "-input-icon"), w.classList.add(p + "-icon-clear"), w.innerHTML = g.default, b.appendChild(w), w.style.display = "none";

      var _ = document.createElement("button");

      _.setAttribute("type", "button"), _.setAttribute("aria-label", "focus"), _.classList.add(p + "-input-icon"), _.classList.add(p + "-icon-pin"), _.innerHTML = v.default, b.appendChild(_), _.addEventListener("click", function () {
        return y.focus();
      ...
      var x = "",
          T = function T() {
        var t = y.val();
        "" === t ? (_.style.display = "", w.style.display = "none", x !== t && u.emit("clear")) : (w.style.display = "", _.style.display = "none"), x = t;
      };
      ...
      return b.querySelector("." + p + "-input").addEventListener("input", T), ["open", "close", "getVal"].forEach(function (t) {
        ...
        var t;
        b.querySelector("." + p + "-input").removeEventListener("input", T), (t = y.autocomplete).destroy.apply(t, arguments);
      }, u.setVal = function () {
        var t;
    ...
    function i(t, e, i) {
      ...
      if (!0 !== i._allowEmptyCredentials && !t) throw new l.AlgoliaSearchError("Please provide an application ID. " + u);
      if (!0 !== i._allowEmptyCredentials && !e) throw new l.AlgoliaSearchError("Please provide an API key. " + u);
      ...
      if (/:$/.test(h) || (h += ":"), "http:" !== h && "https:" !== h) throw new l.AlgoliaSearchError("protocol must be `http:` or `https:` (was `" + i.protocol + "`)");
      if (this._checkAppIdData(), i.hosts) a(i.hosts) ? (this.hosts.read = r(i.hosts), this.hosts.write = r(i.hosts)) : (this.hosts.read = r(i.hosts.read), this.hosts.write = r(i.hosts.write));else {
    ...
    i.prototype.initIndex = function (t) {
      ...
      function e(n, c) {
        function v(t) {
          ...
          var u = new l.AlgoliaSearchError(t.body && t.body.message, {
            debugData: m,
            statusCode: e
          });
        ...
        function y(e) {
          r("error: %s, stack: %s", e.message, e.stack);
          var n = new Date();
          return m.push({
            currentHost: C,
            headers: a(o),
            ...
            endTime: n,
            duration: n - x
          }), e instanceof l.AlgoliaSearchError || (e = new l.Unknown(e && e.message, e)), d += 1, e instanceof l.Unknown || e instanceof l.UnparsableJSON || d >= p.hosts[t.hostType].length && (f || !g) ? (e.debugData = m, p._promise.reject(e)) : e instanceof l.RequestTimeout ? w() : b();
        }
        ...
        if (p._useCache && (_ = t.url), p._useCache && i && (_ += "_body_" + c.body), p._useCache && h && void 0 !== h[_]) return r("serving response from cache"), p._promise.resolve(JSON.parse(h[_]));
        if (d >= p.hosts[t.hostType].length) return !g || f ? (r("could not get any response"), p._promise.reject(new l.AlgoliaSearchError("Cannot connect to the AlgoliaSearch API. Send an email to support@algolia.com to report and resolve the issue. Application id was: " + p.applicationID, {
          debugData: m
        }))) : (r("switching to fallback"), d = 0, c.method = t.fallback.method, c.url = t.fallback.url, c.jsonBody = t.fallback.body, c.jsonBody && (c.body = s(c.jsonBody)), o = p._computeRequestHeaders({
          additionalUA: u,
          headers: t.headers
        }), c.timeouts = p._getTimeoutsForRequest(t.hostType), p._setHostIndexByType(0, t.hostType), f = !0, e(p._request.fallback, c));
        ...
        return r("method: %s, url: %s, headers: %j, timeouts: %d", S.method, T, S.headers, S.timeouts), n === p._request.fallback && r("using fallback"), n.call(p, T, S).then(v, y);
      }
      ...
      this.apiKey.length > 500 && void 0 !== t.body && (void 0 !== t.body.params || void 0 !== t.body.requests) ? (t.body.apiKey = this.apiKey, o = this._computeRequestHeaders({
        ...
        additionalUA: u,
        headers: t.headers
      }), void 0 !== t.body && (i = s(t.body)), r("request start");
      var m = [],
          v = e(p._request, {
        url: t.url,
        method: t.method,
      ...
      return !1 !== t.withApiKey && (o["x-algolia-api-key"] = this.apiKey), this.userToken && (o["x-algolia-usertoken"] = this.userToken), this.securityTags && (o["x-algolia-tagfilters"] = this.securityTags), e(this.extraHeaders, function (t, e) {
        o[e] = t;
      ...
      var r = this,
        ...
        requests: s(t, function (t) {
          ...
          return void 0 !== t.query && (e += "query=" + encodeURIComponent(t.query)), {
            ...
            params: r._getSearchParams(t.params, e)
          };
        })
      },
      ...
      if (!e(t)) throw new Error(o);
      var s = this;
      return s._promise.all(i(t, function (t) {
        ...
        var e = n(2),
          ...
          return "facetName" === t;
            ...
            u = s._getSearchParams(c, "");

        return s._jsonRequest({
          cache: s.cache,
          method: "POST",
          url: "/1/indexes/" + encodeURIComponent(r) + "/facets/" + encodeURIComponent(l) + "/query",
          hostType: "read",
          body: {
            params: u
          }
      ...
      var i = n(2),
          o = i(this._hostIndexes);
      return o[e] = t, this._partialAppIdDataUpdate({
        hostIndexes: o
      }), t;
    ...
    t.exports = i, i.prototype.clearCache = function () {
      ...
      return this.as._jsonRequest({
        method: "GET",
        url: "/1/indexes/" + encodeURIComponent(i.indexName) + "/" + encodeURIComponent(t) + o,
        hostType: "read",
        callback: n
      });
    ...
    t.exports = function (t, e) {
      ...
      var a = n(31),
          ...
          u = n(46),
          h = n(51);
      e = e || "", s.version = n(53), s.ua = "Algolia for vanilla JavaScript " + e + s.version, s.initPlaces = h(s), i.__algolia = {
        debug: n(8),
        algoliasearch: s
      };
      var p = {
      ...
      return p.hasXMLHttpRequest && (p.cors = "withCredentials" in new XMLHttpRequest()), a(r, t), r.prototype._request = function (t, e) {
        return new o(function (n, i) {
          ...
          function s(t) {
            f || (clearTimeout(d), i(new l.Network({
              more: t
            })));
          }
          ...
          if (!p.cors && !p.hasXDomainRequest) return void i(new l.Network("CORS not supported"));
          t = c(t, e.headers);
          var d,
              f,
              g = e.body,
              ...
              v = !1;
          d = setTimeout(r, e.timeouts.connect), m.onprogress = u, "onreadystatechange" in m && (m.onreadystatechange = h), m.onload = o, m.onerror = s, m instanceof XMLHttpRequest ? m.open(e.method, t, !0) : m.open(e.method, t), p.cors && (g && ("POST" === e.method ? m.setRequestHeader("content-type", "application/x-www-form-urlencoded") : m.setRequestHeader("content-type", "application/json")), m.setRequestHeader("accept", "application/json")), m.send(g);
        });
    ...
    function i(t, e, n) {
      ...
      var d = document.getElementsByTagName("head")[0],
          ...
          m = !1;
      window[g] = function (t) {
        if (l(), p) return void e.debug("JSONP: Late answer, ignoring");
        h = !0, a(), n(null, {
          body: t
        });
      }, t += "&callback=" + g, e.jsonBody && e.jsonBody.params && (t += "&" + e.jsonBody.params);
      var v = setTimeout(c, e.timeouts.complete);
      f.onreadystatechange = r, f.onload = i, f.onerror = u, f.async = !0, f.defer = !0, f.src = t, d.appendChild(f);
    }
    ...
    function i(t) {
      return function (e, i, s) {
        var r = n(2);
        s = s && r(s) || {}, s.hosts = s.hosts || ["places-dsn.algolia.net", "places-1.algolianet.com", "places-2.algolianet.com", "places-3.algolianet.com"], 0 !== arguments.length && "object" != (void 0 === e ? "undefined" : _typeof(e)) && void 0 !== e || (e = "", i = "", s._allowEmptyCredentials = !0);
        var a = t(e, i, s),
            l = a.initIndex("places");
        return l.search = o("query", "/1/places/query"), l.getObject = function (t, e) {
          return this.as._jsonRequest({
            method: "GET",
    ...
    (function (e) {
      ...
      var a,
        ...
        set: function set(t, n) {
          ...
          try {
            var o = JSON.parse(e.localStorage[c]);
            return o[t] = n, e.localStorage[c] = JSON.stringify(o), o[t];
          } catch (e) {
            return i(t, e);
          }
        },
    ...
    function s(t, e) {
      ...
      return {
        empty: t.empty && u.templatify(t.empty),
        header: t.header && u.templatify(t.header),
        footer: t.footer && u.templatify(t.footer),
      ...
      _render: function _render(t, e) {
        ...
        function i() {
          function t(t) {
            ...
            }).append(d.templates.suggestion.apply(this, [t].concat(o))), e.data(a, d.name), e.data(l, d.displayFn(t) || void 0), e.data(c, JSON.stringify(t)), e.children().each(function () {
          ...
          return n = h.element(r).css(this.css.suggestions), i = u.map(e, t), n.append.apply(n, i), n;
        }
    ...
    s.mixin(i.prototype, a, {
        ...
        if (this.isEmpty = s.every(this.datasets, n), this.isEmpty) {
          if (e.length >= this.minLength && this.trigger("empty"), this.$empty) {
            if (e.length < this.minLength) this._hide();else {
              var o = this.templates.empty({
                query: this.datasets[0] && this.datasets[0].query
              });
              this.$empty.html(o), this.$empty.show(), this._show();
            }
      ...
      _moveCursor: function _moveCursor(t) {
        ...
        if (this.isOpen) {
          if (n = this._getCursor(), e = this._getSuggestions(), this._removeCursor(), i = e.index(n) + t, -1 == (i = (i + 1) % (e.length + 1) - 1)) return void this.trigger("cursorRemoved");
          i < -1 && (i = e.length - 1), this._setCursor(o = e.eq(i), !0), this._ensureVisible(o);
        }
      },
      _ensureVisible: function _ensureVisible(t) {
        var e, n, i, o;
        e = t.position().top, n = e + t.height() + parseInt(t.css("margin-top"), 10) + parseInt(t.css("margin-bottom"), 10), i = this.$menu.scrollTop(), o = this.$menu.height() + parseInt(this.$menu.css("padding-top"), 10) + parseInt(this.$menu.css("padding-bottom"), 10), e < 0 ? this.$menu.scrollTop(i + e) : o < n && this.$menu.scrollTop(i + (n - o));
      },
    ...
    i.normalizeQuery = function (t) {
      ...
      clearHintIfInvalid: function clearHintIfInvalid() {
        var t, e, n;
        t = this.getInputValue(), e = this.getHint(), n = t !== e && 0 === e.indexOf(t), "" !== t && n && !this.hasOverflow() || this.clearHint();
      },
      ...
      isCursorAtEnd: function isCursorAtEnd() {
        var t, e, n;
        return t = this.$input.val().length, e = this.$input[0].selectionStart, l.isNumber(e) ? e === t : !document.selection || (n = document.selection.createRange(), n.moveStart("character", -t), t === n.text.length);
      },
      destroy: function destroy() {
    ...
    function i(t) {
      var e, n;
      if (t = t || {}, t.input || l.error("missing input"), this.isActivated = !1, this.debug = !!t.debug, this.autoselect = !!t.autoselect, this.autoselectOnBlur = !!t.autoselectOnBlur, this.openOnFocus = !!t.openOnFocus, this.minLength = l.isNumber(t.minLength) ? t.minLength : 1, this.autoWidth = void 0 === t.autoWidth || !!t.autoWidth, this.clearOnSelected = !!t.clearOnSelected, t.hint = !!t.hint, t.hint && t.appendTo) throw new Error("[autocomplete.js] hint and appendTo options can't be used at the same time");
      this.css = t.css = l.mixin({}, f, t.appendTo ? f.appendTo : {}), this.cssClasses = t.cssClasses = l.mixin({}, f.defaultClasses, t.cssClasses || {}), this.cssClasses.prefix = t.cssClasses.formattedPrefix = l.formatPrefix(this.cssClasses.prefix, this.cssClasses.noPrefix), this.listboxId = t.listboxId = [this.cssClasses.root, "listbox", l.getUniqueId()].join("-");
      var s = o(t);
      this.$node = s.wrapper;
      var r = this.$input = s.input;
      e = s.menu, n = s.hint, t.dropdownMenuContainer && c.element(t.dropdownMenuContainer).css("position", "relative").append(e.css("top", "0")), r.on("blur.aa", function (t) {
        var n = document.activeElement;
        l.isMsie() && (e[0] === n || e[0].contains(n)) && (t.preventDefault(), t.stopImmediatePropagation(), l.defer(function () {
          r.focus();
        }));
      ...
      }).onSync("suggestionClicked", this._onSuggestionClicked, this).onSync("cursorMoved", this._onCursorMoved, this).onSync("cursorRemoved", this._onCursorRemoved, this).onSync("opened", this._onOpened, this).onSync("closed", this._onClosed, this).onSync("shown", this._onShown, this).onSync("empty", this._onEmpty, this).onSync("redrawn", this._onRedrawn, this).onAsync("datasetRendered", this._onDatasetRendered, this), this.input = new i.Input({
        input: r,
        hint: n
    ...
    function o(t) {
      var e, n, i, o;
      e = c.element(t.input), n = c.element(d.wrapper.replace("%ROOT%", t.cssClasses.root)).css(t.css.wrapper), t.appendTo || "block" !== e.css("display") || "table" !== e.parent().css("display") || n.css("display", "table-cell");
      var r = d.dropdown.replace("%PREFIX%", t.cssClasses.prefix).replace("%DROPDOWN_MENU%", t.cssClasses.dropdownMenu);
      i = c.element(r).css(t.css.dropdown).attr({
        role: "listbox",
        id: t.listboxId
      }), t.templates && t.templates.dropdownMenu && i.html(l.templatify(t.templates.dropdownMenu)()), o = e.clone().css(t.css.hint).css(s(e)), o.val("").addClass(l.className(t.cssClasses.prefix, t.cssClasses.hint, !0)).removeAttr("id name placeholder required").prop("readonly", !0).attr({
        "aria-hidden": "true",
        autocomplete: "off",
        spellcheck: "false",
        tabindex: -1
      }), o.removeData && o.removeData(), e.data(a, {
        ...
        style: e.attr("style"),
        type: e.attr("type")
      }), e.addClass(l.className(t.cssClasses.prefix, t.cssClasses.input, !0)).attr({
        autocomplete: "off",
        spellcheck: !1,
        role: "combobox",
      ...
      return n = t.appendTo ? n.appendTo(c.element(t.appendTo).eq(0)).eq(0) : e.wrap(n).parent(), n.prepend(t.hint ? o : null).append(i), {
        wrapper: n,
        input: e,
        hint: o,
        menu: i
    ...
    function r(t, e) {
      var n = t.find(l.className(e.prefix, e.input));
      l.each(n.data(a), function (t, e) {
    ...
    l.mixin(i.prototype, {
      ...
      _onCursorMoved: function _onCursorMoved(t, e) {
        ...
        this.input.setActiveDescendant(i), n && (e && this.input.setInputValue(n.value, !0), this.eventBus.trigger("cursorchanged", n.raw, n.datasetName));
      },
      ...
      _updateHint: function _updateHint() {
        var t, e, n, i, o, s;
        t = this.dropdown.getDatumForTopSuggestion(), t && this.dropdown.isVisible() && !this.input.hasOverflow() ? (e = this.input.getInputValue(), n = h.normalizeQuery(e), i = l.escapeRegExChars(n), o = new RegExp("^(?:" + i + ")(.+$)", "i"), s = o.exec(t.value), s ? this.input.setHint(e + s[1]) : this.input.clearHint()) : this.input.clearHint();
      },
      _autocomplete: function _autocomplete(t) {
        var e, n, i, o;
        e = this.input.getHint(), n = this.input.getQuery(), i = t || this.input.isCursorAtEnd(), e && n !== e && i && (o = this.dropdown.getDatumForTopSuggestion(), o && this.input.setInputValue(o.value), this.eventBus.trigger("autocompleted", o.raw, o.datasetName));
      },
    ...
    t.exports = function (t, e) {
      function n(n, o) {
        t.search(n, e, function (t, e) {
          if (t) return void i.error(t.message);
          o(e.hits, e);
        });
      }

      var r = s(t.as._ua);
      return r && r[0] >= 3 && r[1] > 20 && (e = e || {}, e.additionalUA = "autocomplete.js " + o), n;
    };
  }, function (t, e, n) {
    "use strict";
    ...
    t.exports = function (t, e, n, r) {
      function a(a, l) {
        t.search(a, e, function (t, a) {
          ...
          if (a.hits.length > 0) {
            ...
            var d = s(u.as._ua);
            return d && d[0] >= 3 && d[1] > 20 && (e.additionalUA = "autocomplete.js " + o), void u.search(c(h), p, function (t, e) {
              if (t) return void i.error(t.message);
              var n = [];

              if (r.includeAll) {
                var o = r.allTitle || "All departments";
                n.push(i.mixin({
                  facet: {
                    value: o,
                    count: e.nbHits
      ...
      var l = s(t.as._ua);
      if (l && l[0] >= 3 && l[1] > 20 && (e = e || {}, e.additionalUA = "autocomplete.js " + o), !n.source) return i.error("Missing 'source' key");
      var c = i.isFunction(n.source) ? n.source : function (t) {
        return t[n.source];
      };
    ...
    n(1).element = o;
    var s = n(0);
    s.isArray = o.isArray, s.isFunction = o.isFunction, s.isObject = o.isPlainObject, s.bind = o.proxy, s.each = function (t, e) {
      function n(t, n) {
        return e(n, t);
      }

      o.each(t, n);
    }, s.map = o.map, s.mixin = o.extend, s.Event = o.Event;
    var r = "aaAutocomplete",
        a = n(58),
        l = n(20);
    i.sources = a.sources, i.escapeHighlightedString = s.escapeHighlightedString;
        ...
        var e = function () {
          ...
          return Q.matches = function (t, e) {
            ...
            var i,
                o = t.parentNode,
                s = !o;
            return s && (o = J).appendChild(t), i = ~Q.qsa(o, e).indexOf(t), s && J.removeChild(t), i;
          }, E = function E(t) {
            ...
            var i, o, s;
            return H.test(t) && (i = S(I.createElement(RegExp.$1))), i || (t.replace && (t = t.replace(R, "<$1></$2>")), e === C && (e = z.test(t) && RegExp.$1), e in V || (e = "*"), s = V[e], s.innerHTML = "" + t, i = S.each($.call(s.childNodes), function () {
              s.removeChild(this);
            ...
            if ("string" == typeof t) {
              ...
              if (n(t)) return S(I).ready(t);
              if (Q.isZ(t)) return t;
              if (tt(t)) i = l(t);else if (s(t)) i = [t], t = null;else if (z.test(t)) i = Q.fragment(t.trim(), RegExp.$1, e), t = null;else {
                if (e !== C) return S(e).find(t);
                i = Q.qsa(I, t);
              }
            }
            ...
            var n,
                ...
                s = i || o ? e.slice(1) : e,
                r = Y.test(s);
            return t.getElementById && r && i ? (n = t.getElementById(s)) ? [n] : [] : 1 !== t.nodeType && 9 !== t.nodeType && 11 !== t.nodeType ? [] : $.call(r && !i && t.getElementsByClassName ? o ? t.getElementsByClassName(s) : t.getElementsByTagName(e) : t.querySelectorAll(e));
            ...
            var e = Number(t),
                n = void 0 === t ? "undefined" : _typeof(t);
            ...
            not: function not(t) {
              ...
              if (n(t) && t.call !== C) this.each(function (n) {
                ...
                var i = "string" == typeof t ? this.filter(t) : a(t) && n(t.item) ? $.call(t) : S(t);
            ...
            closest: function closest(t, e) {
              var n = [],
                  i = "object" == (void 0 === t ? "undefined" : _typeof(t)) && S(t);
            ...
            offset: function offset(e) {
              ...
              if (I.documentElement !== this[0] && !S.contains(I.documentElement, this[0])) return {
                top: 0,
                left: 0
              };
            ...
            css: function css(t, n) {
              if (arguments.length < 2) {
                ...
                if ("string" == typeof t) {
                  if (!i) return;
                  return i.style[E(t)] || getComputedStyle(i, "").getPropertyValue(t);
                }
            ...
            removeClass: function removeClass(t) {
              return this.each(function (e) {
                if ("className" in this) {
                  ...
                  A = w(this), y(this, t, e, A).split(/\s+/g).forEach(function (t) {
                    A = A.replace(h(t), " ");
                  }), w(this, A.trim());
                }
              });
            ...
            S.fn[t] = function (n) {
              var s,
                  r = this[0];
              return n === C ? i(r) ? r["inner" + e] : o(r) ? r.documentElement["scroll" + e] : (s = this.offset()) && s[t] : this.each(function (e) {
            ...
            S.fn[n] = function () {
              ...
              return r.length < 1 ? this : this.each(function (e, n) {
                ...
                var l = S.contains(I.documentElement, s);
                r.forEach(function (e) {
                  if (a) e = e.cloneNode(!0);else if (!s) return S(e).remove();
                  s.insertBefore(e, n), l && x(e, function (e) {
        ...
        return function (e) {
          ...
          function l(t, i, s, l, c, h, d) {
            ...
            i.split(/\s/).forEach(function (n) {
              ...
              var i = o(n);
              i.fn = s, i.sel = c, i.e in _ && (s = function s(t) {
              ...
              i.proxy = function (e) {
                if (e = u(e), !e.isImmediatePropagationStopped()) {
                  e.data = l;
                  var n = f.apply(t, e._args == p ? [e] : [e].concat(e._args));
          ...
          y.click = y.mousedown = y.mouseup = y.mousemove = "MouseEvents", e.event = {
            ...
            if (m(i)) return o ? (o.unshift(t[i], t), e.proxy.apply(null, o)) : e.proxy(t[i], t);
          ...
          e.fn.delegate = function (t, e, n) {
            ...
            return t && !m(t) ? (e.each(t, function (t, e) {
              ...
              s && (r = function r(t) {
                ...
                if (s && s !== p) return i = e.extend(h(t), {
                  currentTarget: s,
                  liveFired: p
                }), (r || o).apply(s, [i].concat(f.call(arguments, 1)));
              }), l(p, t, o, i, n, a || r);
            }));
          ...
          function n(e, n, s) {
            var l = e[a] || (e[a] = ++t.uuid),
                c = o[l] || (o[l] = i(e));
            return void 0 !== n && (c[r(n)] = s), c;
          }

          function i(e) {
            var n = {};
            return t.each(e.attributes || l, function (e, i) {
      ...
      function n() {
        if (n.enabled) {
          var t = n,
              i = +new Date(),
              o = i - (c || i);
          t.diff = o, t.prev = c, t.curr = i, c = i;
    ...
    e = t.exports = o.debug = o.default = o, e.coerce = l, e.disable = r, e.enable = s, e.enabled = a, e.humanize = n(74), e.names = [], e.skips = [], e.formatters = {};
    var c;
  }, function (t, e, n) {
    (function (e, n) {
      !function (e, n) {
        t.exports = function () {
          ...
          function u(t) {
            var e = this;
            if (t && "object" == (void 0 === t ? "undefined" : _typeof(t)) && t.constructor === e) return t;
            var n = new e(h);
            return b(n, t), n;
          }
          ...
          function C(t, e, n, i) {
            var o = t._subscribers,
                s = o.length;
            t._onerror = null, o[s] = e, o[s + J] = n, o[s + Z] = i, 0 === s && t._state && W(T, t);
          }
          ...
          function A(t, e, n, o) {
            ...
            e._state !== Q || (s && l ? b(e, r) : c ? x(e, a) : t === J ? _(e, r) : t === Z && x(e, r));
          }
          ...
          K = V ? function () {
            ...
            return t.port1.onmessage = l, function () {
            ...
            try {
              ...
              return M = t.runOnLoop || t.runOnContext, r();
            } catch (t) {
              return a();
            }
          }() : a();
          ...
          var G = Math.random().toString(36).substring(2),
            ...
            return t.prototype._enumerate = function (t) {
              ...
              if (i === u) {
                var o = f(t);
                if (o === c && t._state !== Q) this._settledAt(t._state, e, t._result);else if ("function" != typeof o) this._remaining--, this._result[e] = t;else if (n === it) {
                  var s = new n(h);
                  y(s, t, o), this._willSettleAt(s, e);
              ...
              var i = this.promise;
              i._state === Q && (this._remaining--, t === Z ? x(i, n) : this._result[e] = n), 0 === this._remaining && _(i, this._result);
    ...
    function o() {
      if (!a) {
        ...
        for (var t = p.length, e = setTimeout(i); t;) {
          for (l = p, p = []; l && ++h < t;) {
            l[h].run();
          }
    ...
    t.exports = function (t, e) {
      ...
      if ("number" === s && !1 === isNaN(t)) return e.long ? o(t) : i(t);
    ...
    t.exports = n, n.EventEmitter = n, n.prototype._events = void 0, n.prototype._maxListeners = void 0, n.defaultMaxListeners = 10, n.prototype.setMaxListeners = function (t) {
      ...
      if (n = this._events[t], r(n)) return !1;
      ...
      } else if (s(n)) for (a = Array.prototype.slice.call(arguments, 1), c = n.slice(), o = c.length, l = 0; l < o; l++) {
        c[l].apply(this, a);
      }
      return !0;
      ...
      return this._events || (this._events = {}), this._events.newListener && this.emit("newListener", t, i(e.listener) ? e.listener : e), this._events[t] ? s(this._events[t]) ? this._events[t].push(e) : this._events[t] = [this._events[t], e] : this._events[t] = e, s(this._events[t]) && !this._events[t].warned && (o = r(this._maxListeners) ? n.defaultMaxListeners : this._maxListeners) && o > 0 && this._events[t].length > o && (this._events[t].warned = !0, console.error("(node) warning: possible EventEmitter memory leak detected. %d listeners added. Use emitter.setMaxListeners() to increase limit.", this._events[t].length), "function" == typeof console.trace && console.trace()), this;
      ...
      if (n = this._events[t], r = n.length, o = -1, n === e || i(n.listener) && n.listener === e) delete this._events[t], this._events.removeListener && this.emit("removeListener", t, e);else if (s(n)) {
        for (a = r; a-- > 0;) {
    ...
    var i = Object.prototype.hasOwnProperty,
      ...
      var p = c && n;
      if (a && t.length > 0 && !i.call(t, 0)) for (var d = 0; d < t.length; ++d) {
        h.push(String(d));
      }
    ...
    t.exports = function (t) {
      ...
      return n || (n = "[object Array]" !== e && null !== t && "object" == (void 0 === t ? "undefined" : _typeof(t)) && "number" == typeof t.length && t.length >= 0 && "[object Function]" === i.call(t.callee)), n;
    };
  }, function (t, e, n) {
    "use strict";
    ...
    t.exports = function (t, e, n, a) {
      return e = e || "&", n = n || "=", null === t && (t = void 0), "object" == (void 0 === t ? "undefined" : _typeof(t)) ? i(r(t), function (r) {
        var a = encodeURIComponent(o(r)) + n;
        return s(t[r]) ? i(t[r], function (t) {
  ...
  var e,
    ...
    _init: function _init(e) {
      ...
      r[e.id] = !1, s[e.id] = 0, n.data("popup-initialized") || (n.attr("data-popup-initialized", "true"), h._initonce(e)), i.autoopen && setTimeout(function () {
        h.show(e, 0);
      }, 0);
    },
    _initonce: function _initonce(n) {
      ...
      if (a = parseInt(r.css("margin-right"), 10), c = void 0 !== document.body.style.webkitTransition || void 0 !== document.body.style.MozTransition || void 0 !== document.body.style.msTransition || void 0 !== document.body.style.OTransition || void 0 !== document.body.style.transition, "tooltip" == l.type && (l.background = !1, l.scrolllock = !1), l.backgroundactive && (l.background = !1, l.blur = !1, l.scrolllock = !1), l.scrolllock) {
        var p, d;
        void 0 === e && (p = t('<div style="width:50px;height:50px;overflow:auto"><div/></div>').appendTo("body"), d = p.children(), e = d.innerWidth() - d.height(99).innerWidth(), p.remove());
      }

      if (s.attr("id") || s.attr("id", "j-popup-" + parseInt(1e8 * Math.random(), 10)), s.addClass("popup_content"), r.prepend(n), s.wrap('<div id="' + n.id + '_wrapper" class="popup_wrapper" />'), i = t("#" + n.id + "_wrapper"), i.css({
        opacity: 0,
        visibility: "hidden",
        position: "absolute"
      }), u && i.css("cursor", "pointer"), "overlay" == l.type && i.css("overflow", "auto"), s.css({
        opacity: 0,
        visibility: "hidden",
        display: "inline-block"
      }), l.setzindex && !l.autozindex && i.css("z-index", "100001"), l.outline || s.css("outline", "none"), l.transition && (s.css("transition", l.transition), i.css("transition", l.transition)), s.attr("aria-hidden", !0), l.background && !t("#" + n.id + "_background").length) {
        r.prepend('<div id="' + n.id + '_background" class="popup_background"></div>');
        var f = t("#" + n.id + "_background");
        f.css({
          opacity: 0,
          visibility: "hidden",
      ...
      "overlay" == l.type && (s.css({
        ...
        left: 0,
        textAlign: "center"
      }, l.backgroundactive && (o.position = "relative", o.height = "0", o.overflow = "visible"), i.css(o), i.append('<div class="popup_align" />'), t(".popup_align").css({
        display: "inline-block",
        verticalAlign: "middle",
        height: "100%"
      })), s.attr("role", "dialog");
      ...
      }), s.attr("aria-labelledby") || s.attr("aria-label") || s.attr("aria-labelledby", t(g).attr("id"));
      var m = l.closeelement ? l.closeelement : "." + n.id + "_close";
      t(document).on("click", m, function (t) {
    ...
    show: function show(o, u) {
      ...
      if (!d.data("popup-visible")) {
        d.data("popup-initialized") || h._init(o), d.attr("data-popup-initialized", "true");
        var f = t("body"),
            g = d.data("popupoptions"),
            m = t("#" + o.id + "_wrapper"),
            v = t("#" + o.id + "_background");

        if (p(o, u, g.beforeopen), r[o.id] = u, setTimeout(function () {
          l.push(o.id);
        }, 0), g.autozindex) {
          for (var y = document.getElementsByTagName("*"), b = y.length, w = 0, _ = 0; _ < b; _++) {
            var x = t(y[_]).css("z-index");
            "auto" !== x && (x = parseInt(x, 10), w < x && (w = x));
          }

          s[o.id] = w, g.background && s[o.id] > 0 && t("#" + o.id + "_background").css({
            zIndex: s[o.id] + 1
          }), s[o.id] > 0 && m.css({
            zIndex: s[o.id] + 2
          });
        ...
        g.detach ? (m.prepend(o), d.show()) : m.show(), n = setTimeout(function () {
          m.css({
            visibility: "visible",
            opacity: 1
          }), t("html").addClass("popup_visible").addClass("popup_visible_" + o.id), d.addClass("popup_content_visible");
        }, 20), g.scrolllock && (f.css("overflow", "hidden"), f.height() > i.height() && f.css("margin-right", a + e)), g.backgroundactive && d.css({
    ...
    hide: function hide(e) {
      ...
      o.data("popup-visible", !1), 1 === l.length ? t("html").removeClass("popup_visible").removeClass("popup_visible_" + e.id) : t("html").hasClass("popup_visible_" + e.id) && t("html").removeClass("popup_visible_" + e.id), l.pop(), t("html").hasClass("popup_content_visible") && o.removeClass("popup_content_visible"), s.keepfocus && setTimeout(function () {
        ...
        visibility: "hidden",
        opacity: 0
      }), t(s.pagecontainer).attr("aria-hidden", !1), o.attr("aria-hidden", !0), p(e, r[e.id], s.onclose), c && "0s" !== o.css("transition-duration") ? o.one("transitionend", function (t) {
    ...
    reposition: function reposition(e, n) {
      ...
      if (n = n || 0, "tooltip" == s.type) {
        r.css({
          position: "absolute"
        });
        var a;
        a = s.tooltipanchor ? t(s.tooltipanchor) : s.openelement ? t(s.openelement).filter('[data-popup-ordinal="' + n + '"]') : t("." + e.id + '_open[data-popup-ordinal="' + n + '"]');
        var l = a.offset();
        "right" == s.horizontal ? r.css("left", l.left + a.outerWidth() + s.offsetleft) : "leftedge" == s.horizontal ? r.css("left", l.left + a.outerWidth() - a.outerWidth() + s.offsetleft) : "left" == s.horizontal ? r.css("right", i.width() - l.left - s.offsetleft) : "rightedge" == s.horizontal ? r.css("right", i.width() - l.left - a.outerWidth() - s.offsetleft) : r.css("left", l.left + a.outerWidth() / 2 - o.outerWidth() / 2 - parseFloat(o.css("marginLeft")) + s.offsetleft), "bottom" == s.vertical ? r.css("top", l.top + a.outerHeight() + s.offsettop) : "bottomedge" == s.vertical ? r.css("top", l.top + a.outerHeight() - o.outerHeight() + s.offsettop) : "top" == s.vertical ? r.css("bottom", i.height() - l.top - s.offsettop) : "topedge" == s.vertical ? r.css("bottom", i.height() - l.top - o.outerHeight() - s.offsettop) : r.css("top", l.top + a.outerHeight() / 2 - o.outerHeight() / 2 - parseFloat(o.css("marginTop")) + s.offsettop);
    ...
    var s = o.openelement ? o.openelement : "." + e.id + "_open",
        r = t(s + '[data-popup-ordinal="' + n + '"]');
    "function" == typeof i && i.call(t(e), e, r);
  };
  ...
  t(document).on("keydown", function (e) {
    if (l.length) {
      ...
      t(i).data("popupoptions").escape && 27 == e.keyCode && t(i).data("popup-visible") && h.hide(i);
    }
  }), t(document).on("click", function (e) {
    if (l.length) {
      var n = l[l.length - 1],
          i = document.getElementById(n);
      t(i).data("popupoptions").blur && !t(e.target).parents().andSelf().is("#" + n) && t(i).data("popup-visible") && 2 !== e.which && (h.hide(i), "overlay" === t(i).data("popupoptions").type && e.preventDefault());
    }
    ...
    return this.each(function () {
      ...
      if ("object" === (void 0 === e ? "undefined" : _typeof(e))) {
        ...
        n.data("popupoptions", i), o = n.data("popupoptions"), h._init(this);
  ...
  $.fn.typeahead = function (option) {
    return this.each(function () {
      var $this = $(this),
          ...
          options = _typeof2(option) == 'object' && option;
